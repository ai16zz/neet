...
const SM_WALLETS = [
  ...
  {name:"🤔 terp",addr:"HkFt55P3PhRWHXoTFeuvkKEE4ab26xZ1bk6UmXV88Pwz",score:80},
  {name:"🥥 Kevszn",addr:"4fErksUdVqFSF9GSoqeapqvtZwm4YifWvWArdJohLix7",score:80},
  {name:"🐸 earl pump sad",addr:"BK5bTK7mXPTEqdB8CYFwsk8pmjLWVJp127hxoTbSmEHZ",score:80},
  {name:"👻 Created",addr:"B7Jibp8Y6Qot3hhJhmBonpMYnbTttHebw7fnsjK85yrU",score:80},
  {name:"🪵 log new",addr:"AA61V4Ry7Ud7SrKidKqMW1xTfUDsNs8Fr8YmBmjYS7De",score:80},
  {name:"👻 shaw",addr:"DScqtGwFoDTme2Rzdjpdb2w7CtuKc6Z8KF7hMhbx8ugQ",score:80},
  ...
  {name:"🌟 juicyfruityy",addr:"nuttbmvHLMzzTZxC8L8gVBobBtZpXcp9ALdM7yGomjM",score:80},
  ...
  {name:"🌟 juicyfruityy",addr:"BeYkrDVFBXW4Ti4BSfspjeXJWxju9hKBtgL2Diy9krWJ",score:80},
  ...
  {name:"🥷 bandit",addr:"8GrjsuPip1xVDMjyVcVrG1wnM9Rutv7fdoxqtRBaymHc",score:80},
];

// Wallets to monitor for ANY buy — instant Telegram alert regardless of score
const WATCHED_WALLETS=[
  {name:'KayTheDoc',emoji:'👨‍⚕️',addr:'DYAn4XpAkN5mhiXkRB7dGq4Jadnx6XYgu8L5b3WGhbrt'},
  {name:'trey',emoji:'👑',addr:'6TEESe51iQyQRUvEuUGy3hVGpguqF34N9JUfNaURZVxK'},
  {name:'sophie goat',emoji:'👙',addr:'7E9jfxCczubz4FXkkVKzUMHXGwzJxyppC4m7y3ew8ATg'},
  {name:'Cabal',emoji:'💔',addr:'92ot9FuDS7xBA8xXJYMwE3q9vmAhh9ydg5htTgEZVeAv'},
  {name:'Kev',emoji:'🥥',addr:'43F989T2dxVeLNU6DHVyfeKjdXZm6Tq1EtAdfVsmZJ2a'},
  {name:'Kevszn',emoji:'🥥',addr:'CAsytuyXY49AzDZWqx1R5CAaRrpaeqTdPedt74xGw5kK'},
  {name:'crypto villain',emoji:'💯',addr:'5sNnKuWKUtZkdC1eFNyqz3XHpNoCRQ1D1DfHcNHMV7gn'},
  {name:'hesi',emoji:'👁️',addr:'FpD6n8gfoZNxyAN6QqNH4TFQdV9vZEgcv5W4H2YL8k4X'},
  {name:'bwam',emoji:'💢',addr:'bwamJzztZsepfkteWRChggmXuiiCQvpLqPietdNfSXa'},
  {name:'Willy',emoji:'🕖',addr:'777NtBUTG9tVu8Zp1YuuF3T2Hxi9cJzbbG67cHWi1aZ5'},
  {name:'buga',emoji:'🤩',addr:'HABhDh9zrzf8mA4SBo1yro8M6AirH2hZdLNPpuvMH6iA'},
  {name:'migratoor',emoji:'👻',addr:'A8Z1ejQGk45EJibBPJviWnM3UvwKSuYun53nSCkWKM52'},
  {name:'jEE',emoji:'🍄',addr:'54ZZWNRTqwLyaVH68MG8ZR8cfRU5Zppsny7DihVxmjEE'},
  {name:'Tim',emoji:'🍒',addr:'ARN1garjVGC4Ru2JnGsHdLaUQBbQhSXGAi5To3mdeJDz'},
  {name:'h69',emoji:'💊',addr:'6Xypz2cFJMkAwwkgYWjato4PrbbXZAgv1c4okKaPGHmw'},
  {name:'new gake',emoji:'👧',addr:'4Hq9UkSXjEwDZDBMAo9Lnri7VnbQCoomRAdrT6NGMh1c'},
  {name:'rich',emoji:'💰',addr:'richb5CkVbs5kX1MNneB93TcJLfN3AiABMGYz5hEzTz'},
  {name:'chester',emoji:'🍩',addr:'8NJ7Ujpji8uMF2675mqaTSEm2DCbfJA7fiRKtiaqkaLN'},
  {name:'Juicyfruittyy',emoji:'⭐',addr:'J4Dg2TAU889ySrMoNVHEUVwXmAPaNTxZsvJz6TvhrJW6'},
  {name:'Hi',emoji:'🕯️',addr:'7kouZSDLSieVUE7NGyJyRbEbaLGzEcSxVv7Ykmh9X1sS'},
  {name:'Kev',emoji:'🥥',addr:'4dEYoUoDXVvyKjAnBT2M9F4HQhj6bfJ8qFy6HEbBcEfd'},
  {name:'omtad',emoji:'🐷',addr:'EzT4zzdtYEmfkvd6WzA3UeUon2CaGeWZtfPpbopyqa1w'},
  {name:'Cabal',emoji:'👻',addr:'HufqVoEtA6gJrkTnDi9ZwdYozX4V5fXurZbb3tt3jLz4'},
  {name:'PAIN2',emoji:'🧧',addr:'HAN61KQbgzjDBC4RpZJ1ET8v32S4zdKAjoD7EApJ96q6'},
  {name:'jellyjelly',emoji:'🍠',addr:'4qMhJ42sCexUkXgqEkPt9nsyK93d92QeNGKZNyNYPGUb'},
  {name:'henn',emoji:'👼',addr:'FRbUNvGxYNC1eFngpn7AD3f14aKKTJVC6zSMtvj2dyCS'},
  {name:'TDN',emoji:'📲',addr:'65Xh9pNx4ujb2aWGs5kXPmDLXK3Dwo5McyLGEX9KtfME'},
  {name:'leens',emoji:'🍃',addr:'5pxkp8Rpg7xHekFf7URJ25i4P5ZXVk8hRQUaDKytU5K7'},
  {name:'+837K',emoji:'🐻',addr:'4xDDNggBJmahMqJAxZdRVLjs194C6z1XH6FBo3iAqRcv'},
  {name:'porta pog',emoji:'🚢',addr:'BN9bFo7Dh4zS22x3mr7NPQsJsxrMu7b44NbhXXAJZQ6S'},
  {name:'porta pog',emoji:'🚢',addr:'4NJ4Fj9wdqvDZUwbVtVjo7dP1HDv4wNc2Whb4rVFyXeX'},
  {name:'weaver',emoji:'🌪️',addr:'ANxp8yZiQeX5dGQaLsatwUHN6BZMS5sa95aLb47gwNyv'},
  {name:'spuno',emoji:'🫐',addr:'5cs7VtJtornbiTdjhgysN7C5GqV4Y1V1xyH1EQHNoDYc'},
  {name:'Nyvo',emoji:'🌇',addr:'93WHQxFvwT9ZHnD3vK5eqtFgJd7z6pGJCSuA7cg9hQqk'},
  {name:'Nyvo',emoji:'🌆',addr:'HdLytzXLHRUnPD3wMnp2KFvEDzWWQ6Rb7nqqzMKogASr'},
  {name:'criminal',emoji:'👻',addr:'BCquKNKmZ2uhngRFLdiS5px9XEdjiQCmQXD8M6Cd4xWP'},
  {name:'Beezie',emoji:'🦦',addr:'2LWhPiHagG6M1SyrX6STHhSY85dNm1k6wsapnKppjNZe'},
  {name:'copytrader',emoji:'😄',addr:'5W4sXjpeY6DVw3wXrHuf1qWGunwRCjeio7gKXhagB7BR'},
  {name:'doordash',emoji:'🍔',addr:'7BbYhLfW74zRHuxBKW2thtFspuWHYfXBuCqjHvGqpwp2'},
  {name:'Bumper',emoji:'🚗',addr:'DzJW1Kc8r3A2mgEjQ7Qxx6PgV976nPLDMeFPQJTcvUWn'},
  {name:'NPAY',emoji:'💳',addr:'4uFYTjbK86ZTACXyhQMvLZQH3BrrbnPmrcLbx7DYPDam'},
  {name:'bumper',emoji:'🚗',addr:'3jzSDHYGrt2iN9kbUbWkREZVjLJ9TSbEtNb7djY28T35'},
  {name:'OTT4',emoji:'💯',addr:'F9ENp6A75Qr1XR8FGNvEkGkG4GKwNtr1E2TiV5T3Lruj'},
  {name:'profitier',emoji:'💚',addr:'4pqD14u2Wd3MpNsC5tYQeNyJGigGGrcVBLEyjo1XZkxJ'},
  {name:'becker',emoji:'👻',addr:'7bqZMF2Dc5LspsQQeQgBdPKuy8oUm5uztQj9jVTcYXZv'},
  {name:'Faze Megga',emoji:'✡️',addr:'H31vEBxSJk1nQdUN11qZgZyhScyShhscKhvhZZU3dQoU'},
  {name:'pamper',emoji:'💔',addr:'D41BUzvz4W1y5oBQc3ui4adUdAZKEjj3iHuvGup1EZZv'},
  {name:'pamper',emoji:'💔',addr:'AssUhSvBEbN7pVvWqhn4BcCYz5bWRbJLkVSttpdBgNc7'},
  {name:'scharo',emoji:'👝',addr:'4sAUSQFdvWRBxR8UoLBYbw8CcXuwXWxnN8pXa4mtm5nU'},
  {name:'mort',emoji:'☠️',addr:'7McKpCN38mbVu6fzkve4bWTUQFxmVzRDsXH84jyZPpqX'},
  {name:'nom',emoji:'🥷',addr:'4ZjYSCH3Sib9iMSM3QN2sL2kwxNcXG2P4XCemSC2hsyb'},
  {name:'bands ps',emoji:'💔',addr:'ByawfdMmv5d5gUJUo8MdzngTF3GZbNbXxLG8YJo1wfn'},
  {name:'west',emoji:'⛑️',addr:'4L2v6MBtswTi91LNXNoxWc9SFn4eaerTpNsHGSqQCVZW'},
  {name:'copytrader ohK',emoji:'😃',addr:'GiF4hSkBiYgxJ9Rs2FVo8zJunNqpfLJEioL4KAwGtohK'},
  {name:'nolan',emoji:'😀',addr:'3K6NEUXqPj45tmoeSD135ffJ3eo6ouGV2onRWJZFpY3Q'},
  {name:'bnab',emoji:'👻',addr:'B8vnpRRkacuKKdS8tEDamSovXC2tPECheVSRcgNebnab'},
  {name:'dood rapist',emoji:'👻',addr:'9BsZN8E8a84Vvh2UFVJmovUNbbkFiGLABXJqbTf8vRiR'},
  {name:'log',emoji:'🪵',addr:'JAJADxeUZgLtV7kaeCsWW2tyGqZ2tpVa7ctdZsHFESFn'},
  {name:'log',emoji:'🪵',addr:'HAHAJhcY7xWsPVQpMUgnaRgi2uxWBxwhPuuGppr4qmLz'},
  {name:'Time',emoji:'🧭',addr:'TimeAdRpWxqKXR5YPEwGBF48KC5V5TxB2g6mnyCp4VR'},
  {name:'Eow',emoji:'👻',addr:'4x2uPAD4vR83MqHdvEYZYnpoZcZBa8fWUNPyGhoeKEow'},
  {name:'ykn',emoji:'👻',addr:'8mvfpiGG8dK5iYG49eyXZT1sVeJ1F12TpgmdubS49YKN'},
  {name:'R4PE',emoji:'🦊',addr:'6Eq4gQaaGX5NUKe8hp9FGRMFQkY237Homjar418pR4pe'},
  {name:'xXx',emoji:'🧬',addr:'xXxXZxyF6pik6YmTbNDwbYBErJUaRiaxjTJsUABos5G'},
  {name:'trav',emoji:'⛓️',addr:'CXnf4Tt7qFz3KZNwn3Yve5MKaRyxGoAy2eDX3QT8e99m'},
  {name:'baoskee',emoji:'👀',addr:'7FWR2NsCfQP66RTqww9xiSzb3r2jLa3DyiY1oif1oKPu'},
  {name:'kyz',emoji:'👻',addr:'CjNHcTyWYE1q1zX5GgpoPw53Lw5D1f4yUUmqNzd4sVxG'},
  {name:'scharo2',emoji:'👜',addr:'BQ6gHCvYsrSBB37sJvBGrbma1RXWJGdUj5ju3uXwCW82'},
  {name:'terp',emoji:'🤔',addr:'HkFt55P3PhRWHXoTFeuvkKEE4ab26xZ1bk6UmXV88Pwz'},
  {name:'Kevszn',emoji:'🥥',addr:'4fErksUdVqFSF9GSoqeapqvtZwm4YifWvWArdJohLix7'},
  {name:'mitch',emoji:'👽',addr:'4Be9CvxqHW6BYiRAxW9Q3xu1ycTMWaL5z8NX4HR3ha7t'},
  {name:'earl pump sad',emoji:'🐸',addr:'BK5bTK7mXPTEqdB8CYFwsk8pmjLWVJp127hxoTbSmEHZ'},
  {name:'Created',emoji:'👻',addr:'B7Jibp8Y6Qot3hhJhmBonpMYnbTttHebw7fnsjK85yrU'},
  {name:'log new',emoji:'🪵',addr:'AA61V4Ry7Ud7SrKidKqMW1xTfUDsNs8Fr8YmBmjYS7De'},
  {name:'shaw',emoji:'👻',addr:'DScqtGwFoDTme2Rzdjpdb2w7CtuKc6Z8KF7hMhbx8ugQ'},
  {name:'Monki',emoji:'🐒',addr:'53BnNc49Ajgstciq3CRoyxuBpkkW1r8pgPyvr7JGYnsh'},
  {name:'itai',emoji:'💄',addr:'HdxkiXqeN6qpK2YbG51W23QSWj3Yygc1eEk2zwmKJExp'},
  {name:'lunar',emoji:'☀️',addr:'6hHfDSagPQv4ouhr7x17jp9tQNfqUhdJWFHY5mEHnLp2'},
  {name:'Yug1',emoji:'🌐',addr:'AQ46kfYT3hW28Xg5gWHrJkzFSz1oGWBHC3FsTbqgMEco'},
  {name:'dmt',emoji:'🥏',addr:'HF2Lw2tYs4B3y1iqz6iw2f4wTjrn14KppvAezcm7TAT3'},
  {name:'Staticcs',emoji:'😨',addr:'GQetkDMK82cHYXZVqZgv7Lf5Bqo4V5KR8WASQM39x2Uc'},
  {name:'Rename wallet',emoji:'🍊',addr:'DaWrXYYFUbseEDXyHEGCxu2MSeSWkH6WK3eZfijL4z1n'},
  {name:'orangie',emoji:'🍊',addr:'FqrffkWrBX8yCazfECny1YiQhkBme2E39ThEab1cxKfz'},
  {name:'orangie',emoji:'🍊',addr:'BKFsedJTgNLYotumqtrfWPqU1rZkzNBwNVMSenf1KTNt'},
  {name:'orangie',emoji:'🍊',addr:'9ap4XSoATNGdxoeMKrcNWtboatrW2PpTedwWaneQTtMe'},
  {name:'quant',emoji:'🧷',addr:'GRamkEB3FuZeB7vzsP3VywiohRAttrjER5PxmHBGNtQi'},
  {name:'vein',emoji:'🛬',addr:'BtDaZUqHr2mKH5EYQCztuerHBuBEfQNYdquTDtEZp2Ym'},
  {name:'thesis',emoji:'👻',addr:'2cY7x8rVavyw4p7bDYLwctiCeaLqWvyU2xCsqfi4kgqc'},
  {name:'pump sad pablo',emoji:'👻',addr:'JEBy7VuMsCqZDdprhmUNjB1MHTmt5dUFDeMXytbhTLdR'},
  {name:'x',emoji:'🐦',addr:'CLu4FJzmJ4qDfs5aNc64tWQ5B7FUy52CUiA1EeYfftr4'},
  {name:'coinbase',emoji:'💙',addr:'HpabPRRCFbBKSuJr5PdkVvQc85FyxyTWkFM2obBRSvHT'},
  {name:'DEFAULT',emoji:'👻',addr:'HdjAyXGuEMnTBi9vmqb8ws83BpU3hAoyoici8XUy8QSH'},
  {name:'west',emoji:'⛑️',addr:'9AisNb7DJ58ueNC9DLZVx1JgpQ3P93gnvZzmwVef5dRs'},
  {name:'west',emoji:'⛑️',addr:'2j7aWjSxWsRjJrmaYjSmwzH26dDYv3hkvAc2aNhn8oLP'},
  {name:'yolo',emoji:'👂',addr:'B7PrsYQpCZwaMDh2nAKZnAxJKRww91aKtwKjPxWoUfpy'},
  {name:'yolo',emoji:'👂',addr:'G3yqtdtQjJ87ERLMApbwnEeCNzP9BcX6LrR84ut7Qgnw'},
  {name:'kev',emoji:'🥥',addr:'8ah1FdxvQufHRH4LQGoncUmNLc6Mfj7MwD4DM2pewoSH'},
  {name:'aia',emoji:'👻',addr:'3oB4kFkceZmmXPYZT9WJfTYvjkUBS4upr1ssWpV5aa1A'},
  {name:'danny',emoji:'🚔',addr:'3XoUvPJFZ21KeVQBWVDVJP7nQtQvDRvW5n2Mw3wnb5w8'},
  {name:'YourKai',emoji:'👻',addr:'kaiUXfbLaRkCXUd1bT4znGnRBvXqhHZnGcrEkXHvkai'},
  {name:'a16z',emoji:'🍒',addr:'a16ZRRPYzkCgED9ECcFd9vdrFzW775Z2DqmAEsSZDGE'},
  {name:'j sol',emoji:'🪂',addr:'J3WSVQdfyeTy5x5iTEV2bNXnzfoP2a5iT69jE6ZxZRyw'},
  {name:'juciy',emoji:'⭐',addr:'5GdBK4NkaC98cyTFKgjtGyn8kqrWTTxhy3zYMXB3vGZ4'},
  {name:'juicyfruitty',emoji:'⭐',addr:'CkaAt24iBsRmYLnx24MrKe8scrxYxzXDco5AQ2jCq79F'},
  {name:'trey',emoji:'👑',addr:'cfKTJqVCaTt8Z7h46bpNEbymU295GD2ZJ59xf7qAxuM'},
  {name:'trey',emoji:'👑',addr:'GobsYMqCk3VQUueH4VBKuEzbVko4X1PAAi8DSM2gSCSq'},
  {name:'daniww',emoji:'🍬',addr:'8NgSPEZcJBg78z78n4FejqtQZ4HzpWNXMMV7yJiU7PWf'},
  {name:'daniww',emoji:'🍬',addr:'AuPp4YTMTyqxYXQnHc5KUc6pUuCSsHQpBJhgnD45yqrf'},
  {name:'daniww',emoji:'🍬',addr:'G7mfcf5GbZezcBKqcDo5u16TSLARTVxTRSjXxDYbVnaq'},
  {name:'AlxCooks2',emoji:'🍟',addr:'37N7EeV3UDe1zZ4FwL6sJ4BF37WJ1f3wdttKkP1uKseE'},
  {name:'AlxCooks2',emoji:'🍟',addr:'Cs74tKou4YtUtRTv38t3k7sxYss6xFxUZbydiq4Un1qR'},
  {name:'87',emoji:'💔',addr:'cZDRUkxdmTUbUFoVDWeziUL6gfd9MNWGTd8THiN7Rnw'},
  {name:'alx',emoji:'🍟',addr:'7P6tp4KbxZpQrKFXRUbuW3VtDSp7AHAxAC5vYWa1QnBF'},
  {name:'grapist',emoji:'🍇',addr:'DXUDwz9Wu5sSiomqRYkpiB95MrBuxLDRYSNXvCPDnGCM'},
  {name:'pedia2',emoji:'⏩',addr:'8JLaADywkq9r9gUZtzu8NtZ5wpQXEHqjf8bnWSkyuiVN'},
  {name:'absol',emoji:'👻',addr:'HTM87R4mgjDdiF6Yfn8duK9vbDmZxiPCTRbGvm7eCAJY'},
  {name:'kreo',emoji:'🦹',addr:'8HeDT75s5g4CtCimH5B5nySqCiQhtWii8UnZhxBtFo38'},
  {name:'west',emoji:'⛑️',addr:'Dns5honDe4t792ihYDyQNAAPeWDweH6Na8ssxpQYGBT3'},
  {name:'west',emoji:'⛑️',addr:'4jfcYe53QjdceXbiJEAQx54n9dvoUZSn74fMvT84nnKX'},
  {name:'Euris',emoji:'🔪',addr:'FbUikugMfGzCMBmaZSbJrameK5MEBipe2uAsMW9u2jVx'},
  {name:'jack duval',emoji:'🚰',addr:'BAr5csYtpWoNpwhUjixX7ZPHXkUciFZzjBp9uNxZXJPh'},
  {name:'copy',emoji:'😃',addr:'C4iZV7FYFGXtwJxeF38UA1a5uKQv3vpANQWifKBZNuTe'},
  {name:'spuno',emoji:'🫐',addr:'4nUSJJXz32beKEHq5X6Hm8j3F8R27ARSoptFpkqcKw8q'},
  {name:'oxstrategy',emoji:'🧟',addr:'HYWo71Wk9PNDe5sBaRKazPnVyGnQDiwgXCFKvgAQ1ENp'},
  {name:'eeeeeee',emoji:'😁',addr:'eeeeAZZ8jNntdEWRdLgUfL7cDPeYePcD1r2udtTy5yX'},
  {name:'Cupsey',emoji:'🍵',addr:'2fg5QD1eD7rzNNCsvnhmXFm5hqNgwTTG8p7kQ6f3rx6f'},
  {name:'juicyfruityy',emoji:'🌟',addr:'cummwvz2iX8krGFsvd9FebNUBcaQr31rGHaqg9GRYsf'},
  {name:'wiley',emoji:'♠️',addr:'BsjftJFNzwfpT2kAQ2hURZUn9zFoqMQ93CsPLTYEFCUw'},
  {name:'wiley',emoji:'♠️',addr:'6EbQwK1bLmwwHPGYgUtGgH4PVA2Vq683SpmxauJXKC2m'},
  {name:'Juicyfruityy',emoji:'⭐',addr:'8paTPtvmEuZeZh2z3ct9YiKXig2xUdQt9N6Uf7cSWqih'},
  {name:'juicyfruityy',emoji:'🌟',addr:'nuttbmvHLMzzTZxC8L8gVBobBtZpXcp9ALdM7yGomjM'},
  {name:'xander',emoji:'😺',addr:'B3wagQZiZU2hKa5pUCj6rrdhWsX3Q6WfTTnki9PjwzMh'},
  {name:'imera',emoji:'👻',addr:'3AHL1ipiAdbSC6SWUAexZQT7Tzs27dP14XFaf1JfZ55L'},
  {name:'CNDL',emoji:'🕯️',addr:'Dwjy8cPLeBZb33iaAFDfHeLkm4fmUJWCw6cLarkbYrx3'},
  {name:'RICO',emoji:'🖲️',addr:'HiTcw6obM5YAzDWdAzY5rJKh67QhVpKfNRjfDpBtDL3R'},
  {name:'Rewards',emoji:'🍒',addr:'D8QdouVi4bXVyYnFuhwGQXfymkM1XnRzgJZQPB3f4hLt'},
  {name:'juicyfruityy',emoji:'🌟',addr:'6HtCogegBXcEbcjiGMkeuCtvrvaiYD7keU7MLPYDHNHs'},
  {name:'gasp',emoji:'☁️',addr:'8MA4b2s2NJDwRwddutzvAouv2otfgjr9KY6HbGsnwDiT'},
  {name:'3sq',emoji:'👻',addr:'DBzwrJvpDDpUvxGyxHJdoNsswTViaGk5vdoKErr8Y3Sq'},
  {name:'morph',emoji:'🐕‍🦺',addr:'Hgqc79Kz4QoMBo6jrtvds22Hki98hAx4Rvj5oHRUbKZD'},
  {name:'morph',emoji:'🐕‍🦺',addr:'48kEQe5dRSqDn6paQPdeopghWDX3RAuWtb5EcgoatSa4'},
  {name:'Cooker',emoji:'🍳',addr:'8deJ9xeUvXSJwicYptA9mHsU2rN2pDx37KWzkDkEXhU6'},
  {name:'mercy',emoji:'🌥️',addr:'F5jWYuiDLTiaLYa54D88YbpXgEsA6NKHzWy4SN4bMYjt'},
  {name:'Assasin.eth',emoji:'👧🏽',addr:'6LChaYRYtEYjLEHhzo4HdEmgNwu2aia8CM8VhR9wn6n7'},
  {name:'jidn',emoji:'🕵🏻‍♂️',addr:'3h65MmPZksoKKyEpEjnWU2Yk2iYT5oZDNitGy5cTaxoE'},
  {name:'pump sad rlk',emoji:'💔',addr:'GEtFKDqzeTNTW2LtiAYL5ZV3ETwcv68nT9Qav97XaQkY'},
  {name:'revrevrev',emoji:'⚙️',addr:'EgzjRCbcdRiPc1bW52tcvGDnKDbQWCzQbUhDBszD2BZm'},
  {name:'xsv copytrader',emoji:'😀',addr:'3Z19SwGej4xwKh9eiHyx3eVWHjBDEgGHeqrKtmhNcxsv'},
  {name:'trey',emoji:'👑',addr:'BCT2mHG6V254zY5UFtsfKAduzcgJzSLZRRJxRcsGoby4'},
  {name:'radiance fn',emoji:'🔫',addr:'7eyDwQyps2hiLn1cCjqYzqKGWNBzE13rZp53VYYYUYeX'},
  {name:'trey',emoji:'👑',addr:'CbFxEVtevRBgFMyd7mRCScJENRvfECnApkRCHEX6Ef4Z'},
  {name:'ROwdy',emoji:'❣️',addr:'DKgvpfttzmJqZXdavDwTxwSVkajibjzJnN2FA99dyciK'},
  {name:'Q',emoji:'💔',addr:'gangJEP5geDHjPVRhDS5dTF5e6GtRvtNogMEEVs91RV'},
  {name:'orangie',emoji:'🍊',addr:'DuQabFqdC9eeBULVa7TTdZYxe8vK8ct5DZr4Xcf7docy'},
  {name:'juicyfruity',emoji:'🌟',addr:'6cFEC5gStPd5eakZDP3DzVyDT9KhJeqaYBa1WsBa1kyY'},
  {name:'juicyfruityy',emoji:'🌟',addr:'BeYkrDVFBXW4Ti4BSfspjeXJWxju9hKBtgL2Diy9krWJ'},
  {name:'juicyfruity',emoji:'⭐',addr:'C6gKw9VC9mc1KnzxKskATXZc3sNzLTsZpNfNJzKVaG4Y'},
  {name:'Leck',emoji:'🐼',addr:'2mGNGKYNGCNNz4EXrxz4TPckwGkiyGRNe447HncebYRg'},
  {name:'up',emoji:'📉',addr:'DYmsQudNqJyyDvq86XmzAvrU9T7xwfQEwh6gPQw9TPNF'},
  {name:'Pfq',emoji:'👻',addr:'ifCDsh7WDVn3UtgCSUP8Uo75LxFjyGHVxTDZ1wMXPfq'},
  {name:'Felix',emoji:'💔',addr:'3uz65G8e463MA5FxcSu1rTUyWRtrRLRZYskKtEHHj7qn'},
  {name:'raze',emoji:'🌲',addr:'8CLkTAHZt1joF4Swh7YKjGAA8qge1T1SZdoWJJsoGgys'},
  {name:'wiley',emoji:'♠️',addr:'67JSbyEMqJNNcBNzGukvhKRcArJ9qgXPcnyQUJPXNVvC'},
  {name:'H',emoji:'👻',addr:'24hUy7qdkBJT7y3i2ZnUzNTNggVBiPgchcvbXaRfeCL7'},
  {name:'PA!N',emoji:'🧧',addr:'J6TDXvarvpBdPXTaTU8eJbtso1PUCYKGkVtMKUUY8iEa'},
  {name:'Yenni',emoji:'🦄',addr:'5B52w1ZW9tuwUduueP5J7HXz5AcGfruGoX6YoAudvyxG'},
  {name:'pump sad GM',emoji:'💔',addr:'947RGSg6aYnonnEforjVv8cVFHg2QJzPfHJiPmnnsEAL'},
  {name:'good trencher',emoji:'🧨',addr:'2zWtCEUXybiPEuSqayvnppiR3qXBT5mupMBG2qfMTF9K'},
  {name:'jerry cooks',emoji:'🧑‍🍳',addr:'4wG6KEyNR8WAeydHCDkeQYjFJtTBXQJgzyNTTNLqt1b1'},
  {name:'chukballs legion',emoji:'⚔️',addr:'CU35ZDB4JptaBVQWiq1gZsR8kso6dz1bQj8uR3xGn2kK'},
  {name:'CWF',emoji:'💨',addr:'CWFs2YvV5JSHdLecdgrBMGrQZ81dXdzMa6UWj4a8b9Yr'},
  {name:'EYB',emoji:'🤗',addr:'EYBJLQhCjyPhEBiZLAZN99qQqi53MX8SD9tndkTHj9JY'},
  {name:'alon',emoji:'😎',addr:'6DtEedWf9Wk5hA7Xth82Eq441yf5DA4aGLqaQAVfDokm'},
  {name:'smart dev',emoji:'😀',addr:'7BtwAHaXCki5BKFQz2fKQQAjmNWiq6JkmTS6GwTX5kfi'},
  {name:'ORB',emoji:'🖲️',addr:'CztkV1nTjdcboLYSDyNYvavksjavwxjVx2vgkBN1LKTm'},
  {name:'SmokezXBT',emoji:'🗻',addr:'5t9xBNuDdGTGpjaPTx6hKd7sdRJbvtKS8Mhq6qVbo8Qz'},
  {name:'aloh',emoji:'🎟️',addr:'xXpRSpAe1ajq4tJP78tS3X1AqNwJVQ4Vvb1Swg4hHQh'},
  {name:'juicyfruitty',emoji:'🌟',addr:'rapeBWSxw7AW4oxzmUEndNK1o6JAcUh2s1TJqMYiaqD'},
  {name:'lonely',emoji:'🤕',addr:'H4CbfVU4NWYkAgbCnsQscZxdBk6SEzEk8sac9Y8QoU2Q'},
  {name:'pigeon',emoji:'🐦',addr:'C8gWvcHV4AiFrMY2xi2ikjrBWD6P5rwzzwjMTVDM42xC'},
  {name:'suppress',emoji:'🔺',addr:'KYSGYZp17p7hGsoTJRB4ffy3dpu5M6Xi77YKvB9Z4hs'},
  {name:'criminal',emoji:'👻',addr:'ALiR2LoYLUAcU8NAeVFAuP1sUinQS9Cm5NaRKmpyupLj'},
  {name:'key',emoji:'👚',addr:'4Bdn33fA7LLZQuuXuFLSxtPWGAUnMBcreQHfh9MXuixe'},
  {name:'ani dev',emoji:'👻',addr:'Gj4s6v2LRLnhkDgZ7MAEU8VTgqygBFVJJh2odKNdGqWZ'},
  {name:'dust dev',emoji:'👻',addr:'4hyHStoAdFssn2rVmw8W84nu69qsuWvCA6WRw7avHB4T'},
  {name:'slander',emoji:'♣️',addr:'DR7ghPiRVBJ3YeP3FUJRuSa4XaWq4Pkw8ZM4JYs1PyJ9'},
  {name:'poopymcdink',emoji:'💩',addr:'EuC9bwq7AhtvgqhzFG5TtB2q8PYmgWbQ7Eei7FaC4oG3'},
  {name:'gengar',emoji:'😈',addr:'GH6qWg954466eqMJ5hU5Lt3dpjmuDCyBEMaL8vqrsu8b'},
  {name:'CVNNOR',emoji:'⚓',addr:'9bAHNiCf3s4N7m2pJzdvWXRDsk9eRkSSbaYVSzAVb9Dv'},
  {name:'Finn Bags',emoji:'🛍️',addr:'BTeqNydtKyDaSxQNRm8ByaUDPK3cpQ1FsXMtaF1Hfaom'},
  {name:'rand cabal',emoji:'🥌',addr:'D6B4C5KopAs3TPibLGN2qKDEPjiLmpWdZuZies81cfyC'},
  {name:'b2b-power',emoji:'❤️‍🔥',addr:'EjWBrhPapQzjKtNkCXg2j62wfqHpaF9zQYYPgJcBEGam'},
  {name:'mort',emoji:'☠️',addr:'AjiGHTZaj5iLGsDhwnLT5DVyGP1sc7mQGsVQt7kvvhpf'},
  {name:'ozarke',emoji:'🔭',addr:'DZAa55HwXgv5hStwaTEJGXZz1DhHejvpb7Yr762urXam'},
  {name:'Bu6',emoji:'🥭',addr:'Bu6PXhZoxGG7MMKdEMMK8ZSB3UCbU59sPbn8EqiQReY7'},
  {name:'nyrhox',emoji:'🧊',addr:'87MZqjjJgpuFvaU8GyQJKbZGnCFFhX82qAjBGLRXPfcn'},
  {name:'DEV',emoji:'💫',addr:'DiddyP7tSoS5e26zzy43QVfgTQ3dJ8ZyLibC3uPAAwQk'},
  {name:'chubs',emoji:'💦',addr:'AXgzGEvbgaFeb1xhdXkQc5D5CehZUa89ci2F9ugQPLaA'},
  {name:'Kev2',emoji:'🥥',addr:'EDY5ssvZEx6HHL5BjVs5NjJvc2BHib2pcynZ7v6eMCFZ'},
  {name:'te',emoji:'👻',addr:'8RrMaJXYwANd4zEskfPQuSYE35dTzaYtuwyKz3ewcZQx'},
  {name:'EVE',emoji:'🐩',addr:'EVEAppfhNZGjuxBPEyvr8x3bsdS4xUUw6YiPJyecM3gq'},
  {name:'frank new',emoji:'🌆',addr:'3JoVBiQEA2QKsq7TzW5ez5jVRtbbYgTNijoZzp5qgkr2'},
  {name:'logFARM',emoji:'🪵',addr:'FARMbpT39KzziHDRD3PQaih5Fdp2A6wxEx8Pk3wpqN2R'},
  {name:'logan sleuth',emoji:'🤠',addr:'685zCAGJ1hfasum3fU7YU19hJp4cU6d7jSZjQY1PfiQY'},
  {name:'Realist',emoji:'🌭',addr:'G9VPG4XvHheUUbzPexNzx9Yyx97ii53WYb89PvdM2qQk'},
  {name:'s1mple do not buy',emoji:'🚩',addr:'AeLaMjzxErZt4drbWVWvcxpVyo8p94xu5vrg41eZPFe3'},
  {name:'cis dev',emoji:'🪐',addr:'BwaVFCDJ4HfRfFWq1S23LHkk5VF4GKEw9oz7F1PxgcHv'},
  {name:'Wizard',emoji:'✨',addr:'4gMyDeCtXpUN91WUJuL8YH9hCDNd67FSQ6S8xZp3MjQe'},
  {name:'CNDL',emoji:'🕯️',addr:'AzLRkTZDN8XhtJ9owcdEwTjhk5utNVYcLxAcPvPyAQfT'},
  {name:'ORB',emoji:'🖲️',addr:'74kd7Z5LRLhXa17vxDwdELbaHb4h33L2XcYUAXZQcBa3'},
  {name:'x',emoji:'🐦',addr:'4qVQPBGkVZ611JhXqfKp8jm1zjC5SUtoNYAKwGz2VN48'},
  {name:'earl pump sad',emoji:'🐸',addr:'F2SuErm4MviWJ2HzKXk2nuzBC6xe883CFWUDCPz6cyWm'},
  {name:'brez',emoji:'🏝️',addr:'2jyzufCHXmQbhcfAsow84qPEhNRPfbFcfKfg6r6x9c1F'},
  {name:'JDEV',emoji:'👻',addr:'GpLjUnj5q8V6jkaaT7q26rQ4hzn7KYoebLRWfk16hTwh'},
  {name:'AMZ',emoji:'🗺️',addr:'4kkZuoaCU73CgTJPmXLjRBW5nC5Nf3Gi2yE52NCpk5wq'},
  {name:'s2 wallet',emoji:'⭐️',addr:'FgfzLpCJhHYZVji6Sw7omJDEdTq5C12FrV72HzDtwvb5'},
  {name:'Grandfnf2',emoji:'💰',addr:'FVxeFYgyT4GC6D7gaLkMSu2qtSJfw2N4RVPZowi2A64Y'},
  {name:'Grandfnf1',emoji:'🕙',addr:'DGPYpCdiVg2shab2TnNiZ2RnsjBQSmhgN71hJyWC5cYn'},
  {name:'GorillaCap',emoji:'🤹‍♂',addr:'DpNVrtA3ERfKzX4F8Pi2CVykdJJjoNxyY5QgoytAwD26'},
  {name:'pump sad GM',emoji:'💔',addr:'HvpYGTH6uqGia7x6v9ePBuY6mFEvpsJUgXPsqnJmfoRE'},
  {name:'ott4',emoji:'💯',addr:'G84Yz6fDA8wun3po1QG6SrGknK3cha2okXog9MmrqAQt'},
  {name:'orangie huggy',emoji:'🍊',addr:'H66T73iEqzZBrL4jP3sM7AmL1Be816nXysoS4KVxfP4t'},
  {name:'Euris Rel',emoji:'🔪',addr:'2QV7JLCg1rPpcyh3TyznvZ6q7qjBTpJEtmQska6iYVXp'},
  {name:'orangie rel',emoji:'🍊',addr:'ELSyW68qyAToytdaMkyQhgGL9FErGimoPA27AgingJtE'},
  {name:'pump sad h',emoji:'💔',addr:'AjoCbSQP6fz9wb8sUQT1wSnA7C14Rr1dvX7H5VHzxzJJ'},
  {name:'trey multi',emoji:'👑',addr:'5HjsA1SDFNjabGtH7peXnmdnQ4Fqbw8uxwqVwKqdj2FC'},
  {name:'CNDL',emoji:'🕯️',addr:'C2hfZGUsJiUpdFfz4chZrmK3KycBLkkfC8HGpvvf6QWV'},
  {name:'CNDL',emoji:'🕯️',addr:'84pnCqP8dGniC8aS8EN1PeqYZsRazHLBfAm3SWDrVNzP'},
  {name:'motion wallet',emoji:'🤔',addr:'FyNrn5ELHtimjCscVqRK11Q59VaH3knzahtcaPpcmSro'},
  {name:'insdyer crypto',emoji:'🔎',addr:'G3g1CKqKWSVEVURZDNMazDBv7YAhMNTjhJBVRTiKZygk'},
  {name:'log',emoji:'🪵',addr:'BATTp5ZA7gMmvzEhHQVCwpRQcpvKJmkscve1xbAdP6tE'},
  {name:'Juicyfruityy',emoji:'⭐',addr:'Azxhftx1pUhgM7U7MNyuUXMUuwVJeSnx7D2Qk6egScSc'},
  {name:'Juicyfruityy',emoji:'⭐',addr:'5XTpS9Ty5j8oAmP8G3YkiGJwT5NVSJkxB6W3ry9BLTxk'},
  {name:'gake',emoji:'👧',addr:'CNudZYFgpbT26fidsiNrWfHeGTBMMeVWqruZXsEkcUPc'},
  {name:'dust',emoji:'🕳️',addr:'FzVQSzj8JJr6WMGqbUHzx2XH1KkrfxRrRPv6WcbbZmND'},
  {name:'slax',emoji:'🥕',addr:'8b8KVQs22oUF21EyhFqKYK7MdEmsQ9ZuWL8yqvhGQg5P'},
  {name:'roy lee',emoji:'🤓',addr:'Dr7V12M5AcXAC2EEdzMHmwYwgUQbhUcT791szi5pzggw'},
  {name:'washy',emoji:'👽',addr:'GZVSEAajExLJEvACHHQcujBw7nJq98GWUEZtood9LM9b'},
  {name:'Leck',emoji:'🐼',addr:'LeckTHCG66D9CcZoecas8P8AGkNmqbXfAt6LXCKDWhq'},
  {name:'EliteFNF',emoji:'👻',addr:'GB1XcUJ6ddfAdjDHxztKxSieJnyvoVFVHSopDnLc7uWk'},
  {name:'degen guy',emoji:'💔',addr:'amen9NTHYuP5H1ZSbYKdyYYdHv8C48SxDdQ3qSCvSTJ'},
  {name:'connor REO',emoji:'🌼',addr:'9EyPAMyQvXaUWFxd2uQHvG8vpkKs33YdXvDvwmRXrUiH'},
  {name:'hesi',emoji:'👁️‍🗨️',addr:'EF5Bs9zmU7g4eqn79XiihZKdyVapM21Ap2q6qRN2rD8d'},
  {name:'floppa',emoji:'🥸',addr:'bozo8DPprqrU6N3y5cUDMDBCA61wGrk7qfy24Wm5rLB'},
  {name:'profit',emoji:'🏀',addr:'G5nxEXuFMfV74DSnsrSatqCW32F34XUnBeq3PfDS7w5E'},
  {name:'Juicyfruityy',emoji:'⭐',addr:'21wPp9nivRborUDJWALbWcxZRb4za1NyrtykyXgGdxFJ'},
  {name:'CPUTER',emoji:'👻',addr:'9cxJ3BgCdH57CHY2Fwti5JKJ9iKzEsbcp8zGcLeN294d'},
  {name:'Kori Dev',emoji:'🐶',addr:'8T9ychy4shZUYRu6LFjgNYDWPEQ14KEwyNXsr76fcNZy'},
  {name:'WN1K',emoji:'🏀',addr:'DoWxTJ9qgLr6hMpyr9zLXYvKv3MCkZUa77rNcwevWN1K'},
  {name:'juicyfruity',emoji:'🌟',addr:'8sADKnR6w2x7epgby9EeuDwgW1AUT9YbQyHDBEh84CD2'},
  {name:'juicyfruitty',emoji:'🌟',addr:'DwAZENiaTf3F7N2YW6oZxzNh6aQwT9DwytYFYz9HrrWm'},
  {name:'send dev',emoji:'🏹',addr:'26kw2x67UygLCqT9AQwZxNasnbtZdbENStDdrmyidQjC'},
  {name:'juicyfruityy',emoji:'⭐',addr:'DNsqWbXBqtQaGLmrVZ5H4ngscuWRgznnJALGjzFVEWH6'},
  {name:'juicyfruityy',emoji:'⭐',addr:'99EA4VHVZNimrjPTEj92yW7N3DMm5DM1uHncRmUpRLC6'},
  {name:'maxi',emoji:'🦴',addr:'Dj73eZmuEUAms1TrPeb9RUHotFCrtFCeu6BrQ6xrs3a6'},
  {name:'meechie',emoji:'🍏',addr:'9iaawVBEsFG35PSwd4PahwT8fYNQe9XYuRdWm872dUqY'},
  {name:'jidn bundle',emoji:'🕵️‍♂️',addr:'FFDiKhFxjWM6hxLfQduquj42idhwkHQobGHG88UFZwag'},
  {name:'Jerome',emoji:'💔',addr:'EZUBK7Qetzrwiop1yuX58HWeoRs1iHS74z3AH2p7VBTQ'},
  {name:'oscar',emoji:'🐡',addr:'AeLb2RpVwrqKZJ87PEiFdReiEXJXACQn17c8APQS1FHx'},
  {name:'0xSevere',emoji:'🧙🏻‍♂',addr:'9FNz4MjPUmnJqTf6yEDbL1D4SsHVh7uA8zRHhR5K138r'},
  {name:'orangie',emoji:'🍊',addr:'26kZ9rg8Y5pd4j1tdT4cbT8BQRu5uDbXkaVs3L5QasHy'},
  {name:'Lunar',emoji:'👛',addr:'Cz99uWRvpCgsYTQDmK9YxiGcXoqsES1mFYnLMH3RM4Hf'},
  {name:'pr6spr',emoji:'🍒',addr:'sAdNbe1cKNMDqDsa4npB3TfL62T14uAo2MsUQfLvzLT'},
  {name:'Nach Sol',emoji:'🥣',addr:'9jyqFiLnruggwNn4EQwBNFXwpbLM9hrA4hV59ytyAVVz'},
  {name:'rlk pump sad',emoji:'💔',addr:'couhufai96amDSE9v2u4uLANTRG7z3TBx4gZg4sorry'},
  {name:'dubai',emoji:'🏎️',addr:'DuBaiGSB63mXR6KwJoNVG71eavXRJGknW5W3mQdZcg9i'},
  {name:'Loopier',emoji:'♾️',addr:'9yYya3F5EJoLnBNKW6z4bZvyQytMXzDcpU5D6yYr4jqL'},
  {name:'magus',emoji:'🥫',addr:'EK5d8KojLGeS3ec5gByRXFEaXcYymQxxCERnMbJ9HSUA'},
  {name:'Raz',emoji:'🌘',addr:'RAZ9pxT3f3gVCs3jbYZPLHa293YqsA8LfsLx3VPs4so'},
  {name:'Gake',emoji:'💥',addr:'DNfuF1L62WWyW3pNakVkyGGFzVVhj4Yr52jSmdTyeBHm'},
  {name:'Dev GFNF',emoji:'⭐️',addr:'3tc4BVAdzjr1JpeZu6NAjLHyp4kK3iic7TexMBYGJ4Xk'},
  {name:'Euris',emoji:'🔪',addr:'DfMxre4cKmvogbLrPigxmibVTTQDuzjdXojWzjCXXhzj'},
  {name:'Insentos GrandFNF',emoji:'⭐️',addr:'7SDs3PjT2mswKQ7Zo4FTucn9gJdtuW4jaacPA65BseHS'},
  {name:'corleone',emoji:'🐳',addr:'9HCTuTPEiQvkUtLmTZvK6uch4E3pDynwJTbNw6jLhp9z'},
  {name:'EXP',emoji:'✨',addr:'EKDDjxzJ39Bjkr47NiARGJDKFVxiiV9WNJ5XbtEhPEXP'},
  {name:'Waddles',emoji:'🦆',addr:'73LnJ7G9ffBDjEBGgJDdgvLUhD5APLonKrNiHsKDCw5B'},
  {name:'Til Multi',emoji:'⚠️',addr:'E6pP9QF5nJXUrZXbq6egk5j8i5FPNNttvQKbowvcWK6s'},
  {name:'wiley',emoji:'♠️',addr:'mp1V2SpFvcfJoyLPDNHLece3pYWBrmA97qco5GMMNP4'},
  {name:'flames',emoji:'❤️‍🔥',addr:'GiTjPLMYngDKZYxyc2MBFBwsS1Zt3NBCjJtAgsGb3AJv'},
  {name:'orangie',emoji:'🍊',addr:'2V54c75rjibgh6NsDWP88tbpu8KjQ3APRrK5zNQVqx1T'},
  {name:'lunalei dev',emoji:'⚙️',addr:'EnNEiTdV9g2Yau2pHipMvxjjrrMtkECG8Hj8a9WqXGzw'},
  {name:'clukz',emoji:'🐔',addr:'G6fUXjMKPJzCY1rveAE6Qm7wy5U3vZgKDJmN1VPAdiZC'},
  {name:'nitro',emoji:'🚥',addr:'6WjJfqoRZuJdnf6m2xvRTyGp55yBiaJCZdZcYVbRUhKr'},
  {name:'temu gake',emoji:'🦔',addr:'76ZUBj1JLz7arTVHSRJok5oSTEqDuVBgySFMVHtzxzZc'},
  {name:'fuekfarm',emoji:'🧑‍🌾',addr:'D5FuekfarmjWjWNXivth5oHRU4YQFFAQHLmWbityo6Mm'},
  {name:'XwH',emoji:'👻',addr:'BhqDGPFnsDLXVjqeaUMXjohfFKNEmMbiXkBTrMRqeXwH'},
  {name:'juicyfruity',emoji:'🌟',addr:'EBw1HUnpWjj835UxyoN9HdAd9kLiEwWm6b9guCVmAYCt'},
  {name:'doordash main',emoji:'🍔',addr:'8tzURqBY6DpDFHPgzuZetjLfSVcoXeYnnSsAwszLkX1v'},
  {name:'criminal',emoji:'👻',addr:'F5XUMmh1oK3rtzBFVR5z5EbR2xnrijG5YKwgZxzx9gLk'},
  {name:'bumper',emoji:'🚗',addr:'6Dsj4yJK1EZcXDpw1ggcqzMxdFdbkbbTZf69AwZfGyD6'},
  {name:'Glorp',emoji:'💧',addr:'GLoRP4qQ4Mbs9Pks2mGRK84aUvt33RDRmsoXbkwKrGpo'},
  {name:'CNDL',emoji:'🕯️',addr:'6TRUWQ3qNhqDvi7eK7XyTkBpx6uU2VuudVDqB6cfT2Tv'},
  {name:'cb prime',emoji:'💙',addr:'EyYvbWSyDpYeVxS53t4AC1D5Jzn6TUwpCVLgEDxhxAQW'},
  {name:'latuche',emoji:'🥖',addr:'GJA1HEbxGnqBhBifH9uQauzXSB53to5rhDrzmKxhSU65'},
  {name:'bronskee',emoji:'🌋',addr:'BFXwqVGUDkwzMYZKv4Gr5QySSTGcitgyEXfSs7CybgUS'},
  {name:'j sol',emoji:'🪂',addr:'Dcomk8K3DqZgtL4EQx1bAuXpTYZPms2mfzwAjTT73ret'},
  {name:'bandit',emoji:'🥷',addr:'5B79fMkcFeRTiwm7ehsZsFiKsC7m7n1Bgv9yLxPp9q2X'},
  {name:'good trencher',emoji:'🪖',addr:'2F19ZXrvQDCoYXdBoFBiBcEmgrAKYAheZHnQxZksHQhN'},
  {name:'theo pump sad',emoji:'🏳️‍🌈',addr:'Bi4rd5FH5bYEN8scZ7wevxNZyNmKHdaBcvewdPFxYdLt'},
  {name:'Blossom',emoji:'🌸',addr:'62FZUSWPMX9pofoV1uWHMdzFJRjwMa1LHgh2zhdEB7Zj'},
  {name:'Tim',emoji:'🐶',addr:'AJ6MGExeK7FXmeKkKPmALjcdXVStXYokYNv9uVfDRtvo'},
  {name:'publix',emoji:'📢',addr:'86AEJExyjeNNgcp7GrAvCXTDicf5aGWgoERbXFiG1EdD'},
  {name:'caplug',emoji:'🔌',addr:'6qKJ9nAdJWBtSwXACKuMmqQ1M1ySSv2XjGrFMofXZp5a'},
  {name:'braum',emoji:'📛',addr:'34caUhqLdLknMSGJqMYqh8DgkaUdNJwqTVPqiEPgRj4u'},
  {name:'pump sad dan',emoji:'💔',addr:'qNGhUruCGJpXJdsnV74USHErcbm3CrXRsnP8D6Z34Hh'},
  {name:'leck',emoji:'🐼',addr:'BEFo1bApSaFUKqhXq9Cc9M9We5evXkpH5zthVrBhSi7V'},
  {name:'frank new',emoji:'🌇',addr:'3URnnJKdG8eTjrKo7G8rN5GjzweYwSZSxwyJm5Ut5UmL'},
  {name:'al4n',emoji:'🎃',addr:'2YJbcB9G8wePrpVBcT31o8JEed6L3abgyCjt5qkJMymV'},
  {name:'Kenzo ',emoji:'🐯',addr:'ECCKBDWX3MkEcf3bULbLBb9FvrEQLsmPMFTKFpvjzqgP'},
  {name:'Spunosounds',emoji:'🫐',addr:'GfXQesPe3Zuwg8JhAt6Cg8euJDTVx751enp9EQQmhzPH'},
  {name:'til',emoji:'⭐',addr:'EHg5YkU2SZBTvuT87rUsvxArGp3HLeye1fXaSDfuMyaf'},
  {name:'Ferb',emoji:'🛁',addr:'m7Kaas3Kd8FHLnCioSjCoSuVDReZ6FDNBVM6HTNYuF7'},
  {name:'GIBBY/MOODENG',emoji:'🎭',addr:'G1pRtSyKuWSjTqRDcazzKBDzqEF96i1xSURpiXj3yFcc'},
  {name:'5yk',emoji:'💦',addr:'5YkZmuaLhrPjFv4vtYE2mcR6J4JEXG1EARGh8YYFo8s4'},
  {name:'Casino',emoji:'🎲',addr:'8rvAsDKeAcEjEkiZMug9k8v1y8mW6gQQiMobd89Uy7qR'},
  {name:'BINANCE',emoji:'🏦',addr:'5tzFkiKscXHK5ZXCGbXZxdw7gTjjD1mBwuoFbhUvuAi9'},
  {name:'Stxtics',emoji:'😰',addr:'4XMPyWFsYdNcCN4FG8geyytyTeUNacn4QundBzMqbGGT'},
  {name:'RED',emoji:'❤️',addr:'7ABz8qEFZTHPkovMDsmQkm64DZWN5wRtU7LEtD2ShkQ6'},
  {name:'FaZe Banks',emoji:'💸',addr:'CkxVhktjqYuhsVfNQzqEZkwQ2gMU1wEFPM3FSSVXGjM9'},
  {name:'west',emoji:'⛑️',addr:'JDd3hy3gQn2V982mi1zqhNqUw1GfV2UL6g76STojCJPN'},
  {name:'Dior',emoji:'💛',addr:'D2wBctC1K2mEtA17i8ZfdEubkiksiAH2j8F7ri3ec71V'},
  {name:'kanyefnf',emoji:'🏁',addr:'KANYEsXAntLxYUE6GtPJ5CahFGpEbaSbd5xhNFYbvq3'},
  {name:'pow',emoji:'🎆',addr:'8zFZHuSRuDpuAR7J6FzwyF3vKNx4CVW3DFHJerQhc7Zd'},
  {name:'orangie',emoji:'🍊',addr:'BiqkWhrJ4dfpE6TeNY34tA4GssG23SBH8CU8mqB7xZ6t'},
  {name:'orangie',emoji:'🍊',addr:'39qpCe9zdyC2g53UJeyGh5jwGBKjFwidCbnD5W53aVBW'},
  {name:'orangie',emoji:'🍊',addr:'CYqBuDDQEQBJb39uUZWTKoNEdMe9TYdtypkgFn8nDmsC'},
  {name:'ghostee',emoji:'👻',addr:'BD7oWkEQsUwE8sj4UT7jtrGjHC8Gq1iRqXY7U6DTbJpf'},
  {name:'jalen',emoji:'🧱',addr:'F72vY99ihQsYwqEDCfz7igKXA5me6vN2zqVsVUTpw6qL'},
  {name:'Chenz',emoji:'🕷️',addr:'9KAaPdrU2yNmsZoNogcWu22KhmrVdwy1rC438FxjjoSn'},
  {name:'DAVE',emoji:'🍕',addr:'5rkPDK4JnVAumgzeV2Zu8vjggMTtHdDtrsd5o9dhGZHD'},
  {name:'absol',emoji:'🔳',addr:'BXNiM7pqt9Ld3b2Hc8iT3mA5bSwoe9CRrtkSUs15SLWN'},
  {name:'e_dev',emoji:'🦋',addr:'BfUtyNtk82KsUe4rGpdYsTpywMUzYgY62yWuue5nFpi1'},
  {name:'king trey',emoji:'👑',addr:'831yhv67QpKqLBJjbmw2xoDUeeFHGUx8RnuRj9imeoEs'},
  {name:'rev',emoji:'⚙️',addr:'5TuiERc4X7EgZTxNmj8PHgzUAfNHZRLYHKp4DuiWevXv'},
  {name:'Kreo',emoji:'🦹',addr:'BCnqsPEtA1TkgednYEebRpkmwFRJDCjMQcKZMMtEdArc'},
  {name:'ghostee',emoji:'👻',addr:'2kv8X2a9bxnBM8NKLc6BBTX2z13GFNRL4oRotMUJRva9'},
  {name:'x',emoji:'🐦️',addr:'robotqKmKFEJkk8LjUcAsd7P4rxRodQXg7ycStWCMce'},
  {name:'picasso',emoji:'🥜',addr:'BjkpFFRG3NXfY3toyjpWqKPEV9S2RUsvPEJYW2YSrCCz'},
  {name:'essee pump sad',emoji:'💔',addr:'DTRUo2iFAKVf4hFmZaQT6ns7AqXXRawMUuEsV3gp3ktJ'},
  {name:'lunaei pump sad',emoji:'💔',addr:'6XEfkpHJXfu7jd7ZLG1Ngnou1vg7ZTNcM9fjVG5paCCW'},
  {name:'Weaver Mfnf',emoji:'🌪️',addr:'2itf6FWdZUqUb3fKUFPGnaTgqjjvWZwzrz129LCaqFa2'},
  {name:'cented',emoji:'🔥',addr:'CyaE1VxvBrahnPWkqm5VsdCvyS2QmNht2UFrKJHga54o'},
  {name:'Euris drippybruh',emoji:'🔪',addr:'K27kZNq1P9a7A9HMSrkcwzLD7maN2S4VjhZW1ZSAvaG'},
  {name:'mini pow',emoji:'💙',addr:'HwAzzsi2NMirgRDs1LeUTLsPENgfL7pBss5ynEpwV7aY'},
  {name:'Solcrow',emoji:'🦇',addr:'ApRnQN2HkbCn7W2WWiT2FEKvuKJp9LugRyAE1a9Hdz1'},
  {name:'Dan',emoji:'🙈',addr:'J2B5fnm2DAAUAGa4EaegwQFoYaN6B5FerGA5sjtQoaGM'},
  {name:'pump sad esee',emoji:'💔',addr:'4uCT4g7YHH4xxfmfNfKUDenwGrRNGoZ9Ay1XFxfUGhQG'},
  {name:'lowkey',emoji:'🗝️',addr:'9ecRdqNCBxwReiY2pxtnLeayeBzE1CrSSmKKJJGdmsaJ'},
  {name:'witloof dev',emoji:'⚙️',addr:'5f8dDi7o8tGYkFVALB6VixhStULNDxxqNivgWEfr2z17'},
  {name:'solporttom',emoji:'🐕',addr:'42cfcPtPRHN6YQkWMzFhD9N67XWNZnAARYdMoR7RjsLX'},
  {name:'zinc2',emoji:'🧽',addr:'azwKsXexqXFbS3qu4vMCudqBuTdR8zmPpSTR5P1oc3P'},
  {name:'mrclassic',emoji:'🧖‍♂️',addr:'DsqRyTUh1R37asYcVf1KdX4CNnz5DKEFmnXvgT4NfTPE'},
  {name:'Noodle',emoji:'🪖',addr:'8CZjFG1EV3FduGV918QWUh7fevUoZSTffVY8bK6M3wbu'},
  {name:'s2 wallet',emoji:'⭐',addr:'2nNZ3i4GWFU35UyCEW3QX3VFfgaBGLd2M1z3tpGGCHQF'},
  {name:'orangie',emoji:'🍊',addr:'3EAAftccoF4zEeYviKXkNvRqqvzaCNtqQKvRxAkRvuXZ'},
  {name:'dv',emoji:'📲',addr:'BCagckXeMChUKrHEd6fKFA1uiWDtcmCXMsqaheLiUPJd'},
  {name:'danny',emoji:'🚔',addr:'EaVboaPxFCYanjoNWdkxTbPvt57nhXGu5i6m9m6ZS2kK'},
  {name:'og',emoji:'🔌',addr:'215nhcAHjQQGgwpQSJQ7zR26etbjjtVdW74NLzwEgQjP'},
  {name:'qt',emoji:'⌚',addr:'7tiRXPM4wwBMRMYzmywRAE6jveS3gDbNyxgRrEoU6RLA'},
  {name:'JS Shocked',emoji:'⚡',addr:'6m5sW6EAPAHncxnzapi1ZVJNRb9RZHQ3Bj7FD84X9rAF'},
  {name:'Orange',emoji:'🟠',addr:'96sErVjEN7LNJ6Uvj63bdRWZxNuBngj56fnT9biHLKBf'},
  {name:'Jerry Cooks',emoji:'🧑‍🍳',addr:'HKjuMsz7JMuiQhkZsAwqogPf1KwhwACZGMcTmmtesoWv'},
  {name:'juicyfruity',emoji:'⭐',addr:'FaaYKNeYgphhp7WHP26Vc6bXPNqQdQqMvpv5kcHCAETk'},
  {name:'publix rel',emoji:'📢',addr:'BY6L98CXaQxzFAYt16qBPUuqyeCRXf5iWSr8SghzRTw9'},
  {name:'fomo',emoji:'🧙‍♂️',addr:'rp8ntGS7P2k3faTvsRSWxQLa3B68DetNbwe1GHLiTUK'},
  {name:'letterbomb',emoji:'💌',addr:'BtMBMPkoNbnLF9Xn552guQq528KKXcsNBNNBre3oaQtr'},
  {name:'stynx pump sad',emoji:'💔',addr:'2MDe4t6n29Fa9DkZMv2uZxdxbquDp4Jtros2oRQFfeU2'},
  {name:'jijo',emoji:'🦾',addr:'4BdKaxN8G6ka4GYtQQWk4G4dZRUTX2vQH9GcXdBREFUk'},
  {name:'grX',emoji:'⚔️',addr:'GrXjXop95XkVPYJafDJNCLFzK9K8LkpopxYcgUUn2H87'},
  {name:'pamper pump sad',emoji:'💔',addr:'Hgot6ZcPJFAfvVFi8EeqwmhUtrmH3MEoASz5bDLhWjza'},
  {name:'pump sad Artour',emoji:'🤍',addr:'AbS8pM7SMiUyNw6x9UieEBoMkamUmgTw2J1gPxQFnNFd'},
  {name:'WaiterG',emoji:'🃏',addr:'4cXnf2z85UiZ5cyKsPMEULq1yufAtpkatmX4j4DBZqj2'},
  {name:'omtad',emoji:'🐽',addr:'dATMod1UTXYzvaXji4mBsvXTeAUAC73TNJQAejKS54X'},
  {name:'joji',emoji:'🌀',addr:'525LueqAyZJueCoiisfWy6nyh4MTvmF4X9jSqi6efXJT'},
  {name:'pump sad daddy',emoji:'💔',addr:'daddyNgNXujDLijJ3xH9Zq1fXtywKqahvK7LiA2kDHX'},
  {name:'pump sad pablo',emoji:'💔',addr:'3BLjRcxWGtR7WRshJ3hL25U3RjWr5Ud98wMcczQqk4Ei'},
  {name:'hauva',emoji:'🐑',addr:'43FiZWbqc7DDTyhGpGSqQdbEokaDMuCy5nsFtv4P664Z'},
  {name:'wiley',emoji:'♠️',addr:'37yTBV9MbWEgS2gDhCBNV1qM4z6JtKNZawpa6V5BynY8'},
  {name:'Fashr',emoji:'🔷',addr:'719sfKUjiMThumTt2u39VMGn612BZyCcwbM5Pe8SqFYz'},
  {name:'Legion Wallet',emoji:'⚔️',addr:'CDmWZMEUAzJkaPstdvtNgyBzetHZ2kt1ProGDHoXgDCU'},
  {name:'jerry rel',emoji:'🧑‍🍳',addr:'4yh6vFcDRQ9kUkKbeaS9JcxiqkV3PosZEkUa586Fp6Uf'},
  {name:'axiom 1',emoji:'👽',addr:'AAdiaJy2As7g3bnL1nByMPij5wbZAhzVws6vC9VRs9gg'},
  {name:'AlxCooks',emoji:'🍟',addr:'89HbgWduLwoxcofWpmn1EiF9wEdpgkNDEyPjzZ72mkDi'},
  {name:'jidn bundle',emoji:'🕵️',addr:'99LhS8bV8te9ZU8cAorxQE2gtFtqegH88AtMNMx3aHSL'},
  {name:'emteed',emoji:'♦️',addr:'ArBhkg5rtNjEF5Dy2Jt1dHhKb68jB2f1dvrmjqy5LV3e'},
  {name:'Euris 8av',emoji:'🔪',addr:'8AVX6pqm9oE7pPrinccJ65EpquCDiDQ22rHwAPiGdPBM'},
  {name:'printer',emoji:'🖨️',addr:'Bu8iZsGvS5dwuY3GiEDjUSDayEME7LthH4x7TRGTnMXA'},
  {name:'huava',emoji:'👻',addr:'A3CZH8prYMnSqrxEfA7wHbCS5EC4riJ3w7meknDUHgyq'},
  {name:'qavec',emoji:'💔',addr:'CUkXcfgLsQcpCZNQzo9yGUEZ4PE2PVjuy8sTpu6aH3mV'},
  {name:'log2',emoji:'🪵',addr:'9bLyrKkpm2qSsUAZCkQqq4xtXu8e8M6j6gBvEZyhFMKV'},
  {name:'FARM',emoji:'🍒',addr:'FARMvM6h8YDmMvUKXiviWZDZygHhuGuDz9d1vDH8M2TL'},
  {name:'+837K',emoji:'🐻',addr:'7R3KWHxzCf1eevnqHh4YymyTf4WsVJRwVHjrTGiV5zq1'},
  {name:'old',emoji:'👻',addr:'Hn1RmiV69iHDqE6BueATQ2MmPbjZrEmjCuLzSXaSq51H'},
  {name:'ronaldo',emoji:'⚽',addr:'S2qyZ8wwnZgDFVb85ZSeAY6GAnH8iwa3vtzRR1n3CR7'},
  {name:'washy',emoji:'👽',addr:'D9gQ6RhKEpnobPBUdWY5bPQt2p3zGk3iVz6ChpUi2ArA'},
  {name:'XBTPika',emoji:'🐗',addr:'3btmjrS8jqQyysmf7w8hwrKvsEcqHc1HSDHiPJm9Zmap'},
  {name:'skely',emoji:'👻',addr:'973zBrSe9ujPTbvKpxeAb6DVPjmvRmJUUvwXrpxSTfeb'},
  {name:'Euris Copy',emoji:'😀',addr:'7GKcTj9wQfeFJja6okb5shMnGXYsTGFpcVSVPduX1y1r'},
  {name:'danny',emoji:'🚔',addr:'2GaSv3NQKWasZtrDStmpxegyzm6TZtMsYWSbxgtvLA1G'},
  {name:'j sol FSH',emoji:'🪂',addr:'777jiC5vZz3BUota4GrKToPjRYz5oxYJqigwKdXdgpwe'},
  {name:'juicyfruitty',emoji:'⭐',addr:'F4jsgr2bMhLemc6ZX2THhpvrYJh2kbcdNR34tQQX7RrQ'},
  {name:'juicyfruityy',emoji:'⭐',addr:'75yavMLKoyosj5oNMMzy3FkFie5ue94bzsmZFSwMACbd'},
  {name:'denzel',emoji:'👻',addr:'J8Vyp2pN8VQxPDeMqZ6QwRpQCjXqZ1wiW6ndTJmMsUar'},
  {name:'orangie',emoji:'🍊',addr:'7mgVhYzHGYY2CVXqWWx4KLPRjjpSeEVbDqeVk5qqE33h'},
  {name:'GoFuckYourself',emoji:'🖕',addr:'GfyP1QrdDR9T1T9mdF4YBzhkQdE3sCPsJPzost24Uvvs'},
  {name:'pamper',emoji:'👻',addr:'BuM4t6DkNUS8voRNDVTzjC5L46E9VE4JGNervjQY3DSz'},
  {name:'Monki',emoji:'🐒',addr:'GKHxVZQ8UbevjCB2xBZUkgecPDkReJdKmyjzsqHHDgX6'},
  {name:'domy',emoji:'🥚',addr:'rapeGQdKv1unJenbGYDH7Q7J7bGDxVYXXzhKLoMTKFw'},
  {name:'dragon',emoji:'🐲',addr:'9ha3rJRznYVzNkoJ5xyov3ZBjthrC8e8WNdjn48FQyDd'},
  {name:'marcell',emoji:'🍈',addr:'ATFRUwvyMh61w2Ab6AZxUyxsAfiiuG1RqL6iv3Vi9q2B'},
  {name:'Elizabeth',emoji:'😺',addr:'CU2U2xxiRKqoJvDWiyaGMkUqH56rhaHqD8kTd7X1Hu6U'},
  {name:'shah',emoji:'👻',addr:'2WN4rnEmB9c9ouC7VTb4CBXbyiY7qTMcvWUxKKQ2D47T'},
  {name:'ROwdy',emoji:'❣️',addr:'DQu6RDQpMCBn4ZZLL5Wdmn2FqjTu7d2yBTaA22K3xLdv'},
  {name:'x',emoji:'🐦',addr:'HECKePELevz7G8Vm247CNx4PyXpt6tmm9LtBYrDTG26u'},
  {name:'x',emoji:'🐦',addr:'5hQrMQitKo3Yj1k7NXkP2pZioNJtYQ51RXvowFfwVFwt'},
  {name:'7ds cabal',emoji:'👻',addr:'45WFz5zK54nE9yPenAHMgKf9A5esRrEVgEPBey2P56Sq'},
  {name:'7ds cabal',emoji:'👻',addr:'GTTS6p3MwsuddPpyKqL2sA15GM4CPMRa6o66gPoqYh71'},
  {name:'x',emoji:'🐦',addr:'GznY6R31XFuCsF3HGPNRcaahDZRh1FFYjSHZJnAts9U3'},
  {name:'7ds cabal',emoji:'👻',addr:'ACkvMCryf6XyAyZjUZomUHGGuL2eCTJLfCXgyJoCEVPR'},
  {name:'x',emoji:'🐦',addr:'45PmAoy2eoZ6voEkBr1ZGqi1dBJzjHTgYttbFfkwPyH9'},
  {name:'7ds cabal',emoji:'👻',addr:'4fwVuieSpMkRhuKvGAeZdAwADZ9XneTT8xhm6LLs6ND4'},
  {name:'7ds cabal',emoji:'👻',addr:'2LdjVMchpphiTAZHxGZE1Zt9PJEd1X3ZsXAeL9GFSLgo'},
  {name:'Spuno',emoji:'🫐',addr:'EcUvAMJk1q1umWbqVDCsuWeukCj7RCNCQRB84uS8arXV'},
  {name:'Spuno',emoji:'🫐',addr:'H2Y69ASWpu1r4b1frPsvn1ypuxQ2TiWf45vir2rp6cek'},
  {name:'Spuno',emoji:'🫐',addr:'CquHYbTn95ouAcXVRSiv27XdJX2PQnkrYd3deWzwHaYL'},
  {name:'0xTheEye',emoji:'👁️',addr:'39KTKRTmg5YVS5b3nkGhzRVuEGhMcZcEGSPjENaHwePq'},
  {name:'cooldev',emoji:'🆒',addr:'5SW7p56x22LKj8gYcE8DVVd1S59UJUGR9jKq2PFdKiKg'},
  {name:'copy',emoji:'😄',addr:'2Nz4Fqp6mhhyV7aHbE93cxLWhuTPUxRMvZgF5qnWtkfb'},
  {name:'old',emoji:'🧓',addr:'CA4keXLtGJWBcsWivjtMFBghQ8pFsGRWFxLrRCtirzu5'},
  {name:'liquidate him',emoji:'🖕',addr:'7DFA5RUt2HNz6uNRvtJ56EoFUsRcLJDjNPgm5qqG6v8n'},
  {name:'daniww',emoji:'🍬',addr:'3v8mNVUrKsyRs2PUcoFfEY5of4zzRscahpkstGLgmGLS'},
  {name:'daniww',emoji:'🍬',addr:'BKWFf5zmw7PLmBZPUaHk8YXgZbZX5HHf7DT3LV6ViAJy'},
  {name:'daniww',emoji:'🍬',addr:'HLaRgbo8YrVfTh4Nn9MUU2o786RsJ86b4YSAbgjEfV9q'},
  {name:'daniww',emoji:'🍬',addr:'F1FE8k8cguYdzv3UeHgwao2AUgE8zPJzQvQKPiTfT14r'},
  {name:'henn',emoji:'👼',addr:'6gAgy3F1tLxeBWb8UhGEnmXYVRoaz3w1Lzv6APyhfoHk'},
  {name:'Bacardi',emoji:'💔',addr:'4ypAm2m9VfcCQr1WvKNLhkYcW9YgQeC6Xmvgjauwmzez'},
  {name:'weaver',emoji:'🌪️',addr:'D4Z3gesZ2aMT76qXecNKP8pT6ikJj43bjKmZpaGSFMSQ'},
  {name:'3asc (cluely)',emoji:'😎',addr:'3ascXfLsWrXe3F9MoQJjuigGH5w9evcaMhqPEjzCBTsr'},
  {name:'nuno (cluely)',emoji:'🤓',addr:'9RTva4wSk8E3EWYc8wtF9V94RUQGkemWtt3i8dUtsA4P'},
  {name:'grx',emoji:'⚔️',addr:'3N8mFvHeB5G9q3opXp3kCMEtKdpTT1azcBkxxtVUsJrM'},
  {name:'elitefnf',emoji:'☀️',addr:'9BsN4e6rycC5uN8JJY6QXEHo87ix7aLGs5bWyCeUMGdj'},
  {name:'Kevszn',emoji:'🥥',addr:'2A4R5NEjpcfTJCRJNh9iFoQuwxktjs8J7iHoLVS4CTSZ'},
  {name:'bez',emoji:'🤟',addr:'BEZPkD2ukDLjgMv4WtKp83qmuFcdhPQmeqif93eQqwp3'},
  {name:'bez',emoji:'🤟',addr:'BEZPVEj8H4czHGSKpdmWbYM7VqCPSH5EHwwNkyc9uZZB'},
  {name:'himgaj',emoji:'👻',addr:'DxjmHXm1p7cs8Tezdf2EJm5xnwp9QC2E8CbfD1aXeH1j'},
  {name:'waddles',emoji:'🦆',addr:'Ewn4p1M6RHrb7NRQRnK9kfmTzqc1g5x9NhuTvhwu7i94'},
  {name:'zander',emoji:'👻',addr:'C7tSBnqG4tztwEFCjfvFvGhdyaRigWNMuPk6sj88yUwE'},
  {name:'TheBeanMan',emoji:'👾',addr:'FTiSjJYi6aQaE7J4Z8N8m24maYerfPppU5LGzAkmGGKY'},
  {name:'blixze',emoji:'💩',addr:'5vg7he5HibvsAW86wfiuP6jw7VwKmUAnP6P93mVCdpJu'},
  {name:'nitro',emoji:'🚦',addr:'9hTfnPgW2fc5dfBjK6cxkXmuQma6XYoutnydBzJtDf8v'},
  {name:'huge anus',emoji:'👻',addr:'Aqje5DsN4u2PHmQxGF9PKfpsDGwQRCBhWeLKHCFhSMXk'},
  {name:'kev main',emoji:'🥥',addr:'BTf4A2exGK9BCVDNzy65b9dUzXgMqB4weVkvTMFQsadd'},
  {name:'good dev',emoji:'🇲🇭',addr:'4dnWLzmdkLeuDe6hwRBpPqrDbQZ59hpoBu8JLztAescf'},
  {name:'otta',emoji:'💯',addr:'As7HjL7dzzvbRbaD3WCun47robib2kmAKRXMvjHkSMB5'},
  {name:'China Wallet',emoji:'⏰',addr:'286CHN57Km41GsAnDv866WKd6YB6HPSjFgF4rGDJTRLf'},
  {name:'log',emoji:'🪵',addr:'2pUUZYtokRgDV2YzL6M5pjb1jyoHE367yU1sdQ7ac3ea'},
  {name:'fart coin dev',emoji:'💩',addr:'HyYNVYmnFmi87NsQqWzLJhUTPBKQUfgfhdbBa554nMFF'},
  {name:'yolo',emoji:'👂',addr:'Av3xWHJ5EsoLZag6pr7LKbrGgLRTaykXomDD5kBhL9YQ'},
  {name:'legion wallet 1',emoji:'⚔️',addr:'2rmJhgCfqWsh8MqUFchUnsv43EDg55mTh9bkYMT4oPHk'},
  {name:'yolo',emoji:'👻',addr:'8dwubKnL4FmmZsFt9cobpneFWH5azwRqDvciT2vsuQxS'},
  {name:'yolo',emoji:'👻',addr:'8FjipgAr2qxD7hVVkidEmTodNa1pCv1eMEFHk7TbJmED'},
  {name:'theo',emoji:'👤',addr:'mercyjp6vpa75nLGdz2jsTSp1qd9DiUQbMfT3i2QP8v'},
  {name:'ily',emoji:'💖',addr:'5XVKfruE4Zzeoz3aqBQfFMb5aSscY5nSyc6VwtQwNiid'},
  {name:'denza',emoji:'👻',addr:'CkjEpxsd4Lz1mftFMwuYsdd1MjFXYmmakQzaSvguTu5G'},
  {name:'omtad',emoji:'🐷',addr:'8tm6AhQHf9CcpdLs9swLM3DciL1xNsFmB4XqDXJFz4vY'},
  {name:'west',emoji:'⛑️',addr:'4QPHi1odW4kivqEFvW26Ej4vkKJhUnY3ZusV9wGGVqXk'},
  {name:'kadenox',emoji:'🐙',addr:'B32QbbdDAyhvUQzjcaM5j6ZVKwjCxAwGH5Xgvb9SJqnC'},
  {name:'Dragon',emoji:'🐲',addr:'6SYhd67FqypKyNqd5iFikRhrmKAKcCwwurSYUAMNSH4r'},
  {name:'useless dev',emoji:'👻',addr:'ArfVe1K5gt5zsxzRCWSQeWc1rJSJjZzuuYxmvRh71mMQ'},
  {name:'sleuth',emoji:'🛳️',addr:'DXqdaHjmZDELCDtjMNRYsC51roa7WtN3LrZQKheeCphV'},
  {name:'9TJ',emoji:'🕦',addr:'YRfr7z6NzEpbpMmup2ESwWD7g9Zbs378r9M8tTtR9Tj'},
  {name:'rev',emoji:'⚙️',addr:'Fiv89SifFZEaBcmAeiT2zkZCPkLJMrhdeVEi8NcbRGkX'},
  {name:'g1ock',emoji:'💔',addr:'g1ockF6dF3MU9oiKrqhPTSP6cMCWfC5mYLcHkaMERT4'},
  {name:'lexapro',emoji:'💊',addr:'8yJFWmVTQq69p6VJxGwpzW7ii7c5J9GRAtHCNMMQPydj'},
  {name:'ivan HonorFNF',emoji:'🏮',addr:'45yBcpnzFTqLYQJtjxsa1DdZkgrTYponCg6yLQ6LQPu6'},
  {name:'Zrool',emoji:'🍈',addr:'99i9uVA7Q56bY22ajKKUfTZTgTeP5yCtVGsrG9J4pDYQ'},
  {name:'faze trench',emoji:'💸',addr:'BC8yiFFQWFEKrEEj75zYsuK3ZDCfv6QEeMRif9oZZ9TW'},
  {name:'Noot',emoji:'👃',addr:'NootfpGs8pUWw9AotmLnxLPoii562HFzCL2Vd36RrE1'},
  {name:'Euris Dev',emoji:'🍴',addr:'3zv9Neg7Vdyj8HGzP7Mi2j9KvDdVL9Yq7gVdvxK1V6XR'},
  {name:'pamper',emoji:'💔',addr:'ASjhbYr3hpkUJ1vtA6BUnzNDKdrqkd1McYspF6XP6XL1'},
  {name:'lunar main',emoji:'☀️',addr:'GijFWw4oNyh9ko3FaZforNsi3jk6wDovARpkKahPD4o5'},
  {name:'only up',emoji:'👻',addr:'on1yUpq8wmKxFoW1Arnu7G4xwm6T9yJ8dHwyHDfkiKS'},
  {name:'Meteora Quant',emoji:'🪨',addr:'AFf2m58fLB5JGpZqcWT5FY3Gw3YckAAYXWob8puTt1pt'},
  {name:'pullupso',emoji:'⚔️',addr:'GqZqcWNBmn73dQRaybFJUbWXPBtNer9KisArtf8hLTNH'},
  {name:'coyote',emoji:'🐺',addr:'A4DCAjDwkq5jYhNoZ5Xn2NbkTLimARkerVv81w2dhXgL'},
  {name:'Cxltures',emoji:'💿',addr:'3ZtwP8peTwTfLUF1rgUQgUxwyeHCxfmoELXghQzKqnAJ'},
  {name:'Art Bundle',emoji:'🖌️',addr:'AE4HLvqFGtkTKHjWzoBhTRRNPEasz12PdotBFUt2yaVx'},
  {name:'Art Bundle',emoji:'🖌️',addr:'CuLLLGaVnttw9Dc6B8ZKCbxnHmGZn6r6iHqxHBL7y3cS'},
  {name:'suppress',emoji:'🧧',addr:'cumV7jbJLfwuzknZHNKJFULdBVWsXj1MMgXm4SkpdQr'},
  {name:'gurra',emoji:'🪀',addr:'9P9aAh3kdMK651CcDG4iCdoByYj1FJgKq3yVoPrXVCAu'},
  {name:'radiance fn',emoji:'🔫',addr:'FAicXNV5FVqtfbpn4Zccs71XcfGeyxBSGbqLDyDJZjke'},
  {name:'log',emoji:'🪵',addr:'2toRw8MJ3YNVz1xGSXPzP2PBajNWG7YFnLZc1ymrDe5H'},
  {name:'bepis',emoji:'🪴',addr:'HL3FZ8XWnLnn1HuktmgpNRyFRjuAxWbXNQVj5fPPzZwt'},
  {name:'Ethan',emoji:'🙄',addr:'FUahwafcrQAmYKbtbj64QHBxdkZXhtitgxhNVv7wFkgf'},
  {name:'awkchan',emoji:'🍿',addr:'3LYtEmYerFPeXgu1c9Y4553oMk2qVdcxiwWzDjzMkwPx'},
  {name:'ke3d',emoji:'🧶',addr:'2XnxsF2jeRcuCoPY6BUva67itswoUauqFibCQuhKcwGh'},
  {name:'DOGE',emoji:'👻',addr:'56ccEEKRNHL5Ju9nkinFa5kF68WWGUro4nBWeBFwFWBT'},
  {name:'alon',emoji:'😎',addr:'3vkpy5YHqnqJTnA5doWTpcgKyZiYsaXYzYM9wm8s3WTi'},
  {name:'lucas',emoji:'🙈',addr:'FkzekjMLgbXC8NuSQQ2u53rmdh3jhfAZr2psDouDYvfR'},
  {name:'slidrrz',emoji:'📔',addr:'ACTbvbNm5qTLuofNRPxFPMtHAAtdH1CtzhCZatYHy831'},
  {name:'based jup dev',emoji:'🪐',addr:'4kguEV9YRtxuMiUJicpiUQ1itMxosEba4BHCfUTZJP3H'},
  {name:'trump dev',emoji:'👻',addr:'DJTwSyW7woa2N3Nt3L3S77Ef1GS4TfcJsYF5Qm3zcf1k'},
  {name:'theo',emoji:'🫂',addr:'Gake1z6f5jN4EkeWCqhC1BPCc1FrsstpbYB5SJcV4aEm'},
  {name:'yo',emoji:'👻',addr:'EqeB92fxcocvZesSWpHzawtso4nX5nYMFBJXY9kSiVD3'},
  {name:'mayhem agent',emoji:'🧲',addr:'Gygj9QQby4j2jryqyqBHvLP7ctv2SaANgh4sCb69BUPA'},
  {name:'orangie 1k',emoji:'🍎',addr:'FqPaw43zce12cuVmTX6wfZk545UbP4snuQW6Xosc8QQ8'},
  {name:'awkchan',emoji:'🍿',addr:'HAtawFqWtc3CGELWzituM8pg3P8fANejceTBjQKsCrck'},
  {name:'awkchan',emoji:'🍿',addr:'AcpFWXk7hf5RLS3Ee7QDUZrcTATN6R9tEr9j4BEwyYFc'},
  ...
  {name:'Art',emoji:'🖌️',addr:'CgaA9a1JwAXJyfHuvZ7VW8YfTVRkdiT5mjBBSKcg7Rz5'},
  {name:'nitro',emoji:'🚦',addr:'H3U2xEw6pNunJZPAxrdXxqBzB4UZdpoymSp6YJ5o246N'},
  {name:'Keanu',emoji:'💣',addr:'8i5U2uNBEuTc4zskYP14zbebDg2RSwrrG8REhEnJb97K'},
  {name:'Topblaster',emoji:'🍎',addr:'2ihaWVuEe9ed2pVidqgKBCnKix88BYr7xfzRSDWUgTC1'},
  {name:'alohdev',emoji:'🎟️',addr:'buUDD73DW812WofBM5eHhXKMj9jnqmMYMi6eeHKm1UZ'},
  {name:'BES',emoji:'🐶',addr:'BESavbxMyMUVNZT8fBFdDxF4bKSzK2mevvsjxXQyCfyX'},
  {name:'ELV',emoji:'🐶',addr:'ELVGc3WUDPhNNBoH6TirKFUe4fuFHRxeBAQRyjK6NZq2'},
  {name:'dex',emoji:'📇',addr:'mW4PZB45isHmnjGkLpJvjKBzVS5NXzTJ8UDyug4gTsM'},
  {name:'Leck',emoji:'🐼',addr:'98T65wcMEjoNLDTJszBHGZEX75QRe8QaANXokv4yw3Mp'},
  {name:'',emoji:'😀',addr:'G6bFfeb1Vn8BF3Vb8x6MrJeV6moLmb1FEy1Z5AihwMe2'},
  {name:'scharo2',emoji:'👜',addr:'GP25SFBKRQJM7tYHn7JkZ4m9eE8SFXzfSNwyWtUBeLjp'},
  {name:'scharo2',emoji:'👜',addr:'Dmaubz6YGkGezk5nL7rifevdUGLRTfjzAu74s1EujwE6'},
  {name:'Orange',emoji:'🟠',addr:'2X4H5Y9C4Fy6Pf3wpq8Q4gMvLcWvfrrwDv2bdR8AAwQv'},
  {name:'beanz',emoji:'🫘',addr:'VJSDW6S74YXR4rRR9P4xwhMvLZJQMhrUb8XMFirUsy1'},
  {name:'h14',emoji:'🪬',addr:'BJXjRq566xt66pcxCmCMLPSuNxyUpPNBdJGP56S7fMda'},
  {name:'gasp',emoji:'🗯️',addr:'xyzfhxfy8NhfeNG3Um3WaUvFXzNuHkrhrZMD8dsStB6'},
  {name:'gr3g',emoji:'🐊',addr:'J23qr98GjGJJqKq9CBEnyRhHbmkaVxtTJNNxKu597wsA'},
  {name:'Stxtics',emoji:'😨',addr:'DbcM7jJHMG8D68CrfJk86mkX1ntQXKgXawKf2waKYFny'},
  {name:'pippindev',emoji:'👻',addr:'DCj2TAjbSujcdPNVzBAx7fguaufpqwoWTmiAGNUc5Ywg'},
  {name:'TeddyDEV',emoji:'🐻',addr:'3mjHNqaPGVYncmd95w9TC3XGQe3EwGykGZiDQyhDxwhU'},
  {name:'Teddyxroo',emoji:'🐻',addr:'2Agm5qepq5GhdnsUQWAb5JEpF5rXp53eMjFePZNrugga'},
  {name:'Teddyxroo',emoji:'🐻',addr:'EPSKF5xTHSzihBKDdBRV2oWFDqaN5LWZ76x65YzdDHyD'},
  {name:'Tim3',emoji:'🐶',addr:'8ACcmVGPWzcvcJtgxyNZW8V1FyoNH4MuV3v8vNjDTF3t'},
  {name:'Tim4',emoji:'🐶',addr:'2oQUhfbW5rDjNBT9t6d1EHjqhSVWVG5QWgPzfSJtNhRF'},
  {name:'mars',emoji:'🐶',addr:'marsH3rLdpyEWfeXB2vvVj3jckfAQ1kv4BYFhsvLx2Q'},
  {name:'tim6',emoji:'🐶',addr:'4aXk1EXKSHxa6yqDtWmngLsyYCnvMXSQoKisddyempCn'},
  {name:'ChinaAlt',emoji:'⏰',addr:'2JhxVredAL2PN8oigPt5dpUStyZFtabAVnhmCQRi2QTh'},
  {name:'connor REO',emoji:'🌻',addr:'8eGqytw6HWhykdBoA9gNWZv7t7vYr6X8KeoDABU1731y'},
  {name:'connor REO',emoji:'🌻',addr:'7q5MVnzDoLnmLQvmWkKp282eZjSdUcUwWigxatBpnGUr'},
  {name:'connor REO',emoji:'🌻',addr:'2oCAmywXizFf2ECL5RzfNPbRUFByrsMRQWJQG1WxGnWu'},
  {name:'west',emoji:'⛑️',addr:'8ETArCvEyh8wnGkhtZ3AxeifAgGKxFRBsWQurzD3o1WV'},
  {name:'Dior2',emoji:'💛',addr:'CivnsviFr4zwAeG4UTsbzc77t5vKzzQtuZzddTvbtWdA'},
  {name:'aiwass.sol',emoji:'🧚',addr:'BZmxuXQ68QeZABbDFSzveHyrXCv5EG6Ut1ATw5qZgm2Q'},
  {name:'pgeon',emoji:'🐦',addr:'C6qpsGQTAurU9dFTVWVrhpqKfnvDWzHCNSZn8QKDAjRt'},
  {name:'scharo3',emoji:'💼',addr:'6vzubRoM5MrU9u6bZbxLTwwq62D3VsF8qqMZBqgG5GuD'},
  {name:'giann',emoji:'🏀',addr:'GNrmKZCxYyNiSUsjduwwPJzhed3LATjciiKVuSGrsHEC'},
  {name:'Haider',emoji:'🧠',addr:'Haid9XbugV4KWLD8ubmAV9iiM7NoUkb3FKU3cXCHRt6'},
  {name:'Daumen',emoji:'🦆',addr:'8MaVa9kdt3NW4Q5HyNAm1X5LbR8PQRVDc1W8NMVK88D5'},
  {name:'diego',emoji:'🦛',addr:'6ikUcjdzfkdFdsc7o5DXTLpsQLfymeFaajGemAaBGPnx'},
  {name:'kryptix',emoji:'🔱',addr:'AiLwAtCzPnQh6GnJ1UiMi9vqNniV3QyTM4rueKYNjPwN'},
  {name:'jack duval',emoji:'🚰',addr:'6Eegkyd2qNzxSzZz3PH3jiDyqL5HFcHdcsb9zfMzWHKB'},
  {name:'spanish dev',emoji:'😀',addr:'CC9w5c2wUx6d8b68KywEe9jcNNsCv4S8zhRqNPcAc9Fb'},
  {name:'Dior',emoji:'💛',addr:'87rRdssFiTJKY4MGARa4G5vQ31hmR7MxSmhzeaJ5AAxJ'},
  {name:'Miki',emoji:'🧬',addr:'XXXXXahGswEH6i3Czn19XbGxQrobJoY1TYJegPxp3ex'},
  {name:'jerry',emoji:'🙉',addr:'E33jP6RWVpGkv3fDVbuR5Ee6ak42tTKW9yYszqERtobs'},
  {name:'JDZ',emoji:'💛',addr:'JDZdFTTRewfCkux4CarYhgsM2vtUJfbfkEeQEHZXtpss'},
  {name:'david china quant',emoji:'🇨🇳',addr:'J485YzQjuJPLYoFEYjrjxd7NAoLHTiyUU63JwK7kLxRr'},
  {name:'bier',emoji:'🦷',addr:'E4Ruedde4i3tAfXu3sSojAanaHW1b6epsfdXRLbadv5S'},
  {name:'114514',emoji:'🇯🇵',addr:'HtpCoSsZmCkLgu5DdRC2GkNmioXDLLuDrxNHcBHaCTvQ'},
  {name:'chair',emoji:'🪑',addr:'Be24Gbf5KisDk1LcWWZsBn8dvB816By7YzYF5zWZnRR6'},
  {name:'Stxtics',emoji:'😨',addr:'9FCWrtVCXHoyppdZMxBEGvLhdkugLrYTuecQnmd8WjHZ'},
  {name:'kreo',emoji:'🦹',addr:'GK8RNjG4wSD7nF7oyFMCLv9Kdbm76B5KT2AXQEqxffrZ'},
  {name:'kreo',emoji:'🦹',addr:'9RiJQAoWFQ4cgc8BRgR3DYNXVdKYjr2SWavi3nEWp1hs'},
  {name:'Frog',emoji:'🐸',addr:'4DdrfiDHpmx55i4SPssxVzS9ZaKLb8qr45NKY9Er9nNh'},
  {name:'diego',emoji:'🦛',addr:'AgaYcDQRmUJ6Z164qiNRK1PqkGMeGrF6eERHZkAkvkfa'},
  {name:'Nyhrox',emoji:'🧊',addr:'6S8GezkxYUfZy9JPtYnanbcZTMB87Wjt1qx3c6ELajKC'},
  {name:'h14 dev',emoji:'4️⃣',addr:'8inTY66csRNgKNtGhqGhd4odAV2VeJBDcRVuF7UE3Eeh'},
  {name:'connor dev',emoji:'🌻',addr:'HfuZ4EvaPvCGqTNxTZaS2bhSZbRF4gzKGH7PhDbDuaKw'},
  {name:'shah',emoji:'👻',addr:'HknfVes7oCMZ4ygZAovuu2ZjZ8cKZnNyNTsVcFdhfb3d'},
  ...
  {name:'cented brother',emoji:'👋',addr:'6nU2L7MQVUWjtdKHVpuZA9aind73nd3rXC4YFo8KQCy4'},
  {name:'denza',emoji:'🦴',addr:'GH9yk8vgFvHnAD8JZqXxr3hBN1Lr1mJ9NPzrP5mVqiJe'},
  {name:'earl',emoji:'🐸',addr:'7ZnaTAuAtXSAuAqcZkkAHJfomYgViUnFwbnnVn86chis'},
  {name:'earl',emoji:'🐸',addr:'5qmDCnAvQWVZoLwxoAMFfiohS9eU25WB51hiC95nmPrv'},
  {name:'earl',emoji:'🐸',addr:'6avQ6hGL39ipsWxmonFzrbE3Sf4iuwxkmGAPd1z71Rsg'},
  {name:'treydev',emoji:'👑',addr:'BM67m92U4H29Ej64v2UZEAABobYFzdQUCW9pHJ3229zf'},
  ...
  {name:'EIT8',emoji:'💙',addr:'EiT8EySXPcWnJEzk4GbzKCewwJPdi8mFQowjVQ973BMi'},
  ...
  {name:'FnZ',emoji:'🏺',addr:'FnZUzhGe4c1JGJFLrwfX3AdE2VTqbd6aEYyc1AbsMSiy'},
  {name:'aged bundle',emoji:'😀',addr:'7HAcpvFbErSwg4ozzN7Sf3aSJQ6ofZYwQBVsSNhqeh9a'},
  {name:'frank fomo',emoji:'🌇',addr:'498g1rVnFcnjBjpfw1xyqA1WvgQXUU8RWuELjxkjAayQ'},
  {name:'frenzy1tx',emoji:'🪴',addr:'YvEsBWpHK5PJ6Q8m4YrocwKeWys1NG67pbgi73UPnuX'},
  {name:'shocked',emoji:'🌩️',addr:'EcJWNtETrzdbj8s2dXpaE4Tu4r7fxALD6TNw9H8S6ksz'},
  ...
  {name:'shah',emoji:'👻',addr:'7xwDKXNG9dxMsBSCmiAThp7PyDaUXbm23irLr7iPeh7w'},
  {name:'leens',emoji:'🍃',addr:'LeenseyyUU3ccdBPCFCrrZ8oKU2B3T2uToGGZ7eVABY'},
  {name:'smart',emoji:'🧑‍💻',addr:'9PLz3xVWBvr6frWQetsjtCftTgNpk1xwL6BAEf8endQm'},
  {name:'leap',emoji:'🌷',addr:'G3K9kWBDUmtnxypFZSzZDdMS9d8GWnZUrbsvobSJkwVG'},
  {name:'hexi',emoji:'💠',addr:'Fh3kfdQGDwzpiiME3X3h6dsbayd3ufrfP3GrdmJ7LKJT'},
  {name:'87',emoji:'💔',addr:'HpCcbBf6jpJBkBrMzUDzev6qnvQ73yd5LDMrts5a3Fzz'},
  {name:'bronskee',emoji:'🌋',addr:'CDKJ35ZD9jHivyEa3fMbxZSNrTERAS3CbrJbj4vP9f82'},
  {name:'aloh',emoji:'🎟️',addr:'jeWzw4Ys3cXpi5ScafwT6fgQ1jrrxb2iNoRSpjf45aw'},
  {name:'washy',emoji:'👽',addr:'GMwXfLtKhgtWdLqq29pF4JbUUQA6asUeEaXtjQSB7gpN'},
  {name:'washy',emoji:'👽',addr:'4zQG6oUwbjRrzVCG3wMAo6xuEBXe2doupdeeekKmPYUu'},
  {name:'aloh',emoji:'🎟️',addr:'6p7N4iZF9kuFvGk5nZdHDecNKW3Rct9zSDs2yhU1sdv'},
  {name:'21',emoji:'😀',addr:'999999rvdtNP6BXJt2U2d4bNtspZt3yzbbH5kPiJVTCi'},
  {name:'BINANCEAPE',emoji:'🏦',addr:'4wTHK33Vx8QZGhHkYFWnAFzWG2xwR1EpGTDdL7ze5LJo'},
  {name:'suppress',emoji:'🔺',addr:'D4ywmQk5ciaCssU4Kd2HcbFbU6iZcGVSwzUZcHGHYXhz'},
  {name:'wick',emoji:'🕯️',addr:'7SeUfPLcRxthg4EsPa31X56yugTfLSaYED6UZNJeKyqe'},
  {name:'loyal EL',emoji:'😅',addr:'DspCGdG7nHspS3u4RGR4wpgwT6pmh7SdKb6x7Bxb7iEn'},
  {name:'Pain',emoji:'🧧',addr:'5265FEFwZyH6V2U8wPy7xXRsyW4RivBFovkpDnSgs8St'},
  {name:'kryptix',emoji:'🔱',addr:'98H51VZLLvHmBXhyZFRB9Ho1ta5QWHLkGKbvZN8nJszF'},
  ...
  {name:'diego',emoji:'🦛',addr:'Bmrcz8UjAHKGnreBAvpBdWjDR2KYZqQX2f5uC4FkkXTQ'},
  {name:'aloh',emoji:'🎟️',addr:'Cum5exPbTUGJgCUFYvQbBpJB1hibVWcdZrS7Sm9jRP2h'},
  {name:'ozarke',emoji:'🔭',addr:'2h6WT2yEMhpdLQRRX5tm58bEt174sbNZq7tMqzVtm3PW'},
  {name:'waiterg',emoji:'🃏',addr:'7Np5tf39tpvFSzWnGpwa54NeFkocGdr8DzWVHLktGZGp'},
  {name:'mph',emoji:'🦋',addr:'3vhoESzqFKZ7NAEM8cmjwqkxarn2RS12G2rNUmMnNkvn'},
  {name:'mph',emoji:'🦋',addr:'D9Eoby4puakYU3QX8aLGmQ3vqotWYk7V6YD7WtrKDfxw'},
  {name:'mph',emoji:'🦋',addr:'SF9TGdsfTPcA3ZVmPdPtYphgzRg6ZqUY4hnjPgjD1MW'},
  {name:'mph',emoji:'🦋',addr:'8isACVi8Bzknc9Ez6pvFft6e6aptjQTjxYU8LysvZTbn'},
  {name:'mph',emoji:'🦋',addr:'5UKK3PEL5aHLG8Z3c1CeWqK5BmzXqaw5p78h8zSzE28s'},
  {name:'solana badge',emoji:'🗾',addr:'GKXKJRKDrwqyttiF2M9a1LM6YKUSfFHeQ2RhY82Q71RU'},
  {name:'CHRIS',emoji:'😀',addr:'DunhuHYuuh7H231TrDMcUoKmNuMQRnxJ2DfV9nMaqege'},
  {name:'saijax',emoji:'🧨',addr:'4Y8Dbxk3vrDLdA7uPjXXLJN3qShAoLARdSusyvTkYSgQ'},
  {name:'connorreo2',emoji:'🌻',addr:'EwhEwoHVGne4PdjwVePfPEhzBKL1ZL7FTg7VNtscn2Ls'},
  {name:'Kreoalt',emoji:'🦹',addr:'mPEJqsRdVt1YXxuMNc5k9FvJdaS9ENSzAfHq1oPVzx5'},
  ...
  {name:'flufy',emoji:'😀',addr:'6Uh3iHtfriPEDTezVce56Tgb7PS5o1mrRSzqANKt8Set'},
  {name:'icemandot',emoji:'🍙',addr:'5fLWPfB8qjZ8ARUgzL4f7chBuKKj4Fg4EbsA9vW5YKHG'},
  {name:'Kreoalt',emoji:'🦹',addr:'13aTrSA6SUEEAhKL3qc8Ns8tpQMEhffHUW3kecRzFC8X'},
  ...
  {name:'scharo2',emoji:'👜',addr:'Fw57Uot5nGDg5jrUSFRXdCQDJ7xDBFwSCUrvMeADDLYk'},
  {name:'scharo3',emoji:'👜',addr:'874X2TgKNz2fUvZuu3rcbKMvzVPWTU2FNrMzjtwwsjKL'},
  {name:'Flames',emoji:'🧑‍🚒',addr:'6aXFYXbFob1ZKAEDCcqZnX2vooA3TgEqDoy5dAQbeWoV'},
  {name:'Cowboy',emoji:'🤠',addr:'6EDaVsS6enYgJ81tmhEkiKFcb4HuzPUVFZeom6PHUqN3'},
  {name:'Tim',emoji:'🐶',addr:'EdguS1Tx4ieBkyynZ3PUkdvYhb1vNjbDBNncb12NWVnE'},
  {name:'sneaky',emoji:'🐶',addr:'8rFMsTktKFM7HGeaz7fuhTFJqpbdUXBRHjyZZ5L5Sz6e'},
  {name:'vev',emoji:'🦚',addr:'vevK2LNSN4BSfQ4Aq28JtAG8hM2uVip4zwpRZdYL4PV'},
  {name:'vev',emoji:'🦚',addr:'Ctjk6aiH9rFpPejjfbUEVZi9FJZwg8ygT97QQoHGTYqo'},
  {name:'vev',emoji:'🦚',addr:'DU5uapuadiJKycAVgMf4ZKWWxhkhZ9RUuNH6Zk4oS4pz'},
  {name:'aismart',emoji:'🦓',addr:'6uw63EB8yWT99Naqh8L1Lmwi1TwFua8Sozk8dWDYU9rd'},
  {name:'aismart2',emoji:'🦓',addr:'Dwbn2Rkd86rdw2zADCeHmoaQ39jgru9cB47hEQhzaeJ8'},
  {name:'aismart3',emoji:'🦓',addr:'7b31vYgxhRWbT8raLNWcVqJj311bkM8boRqsZsFY9FS6'},
  {name:'Stacker',emoji:'⚡',addr:'HbCxe8yWQJWnK3f3FX4oohgm87FZuPYD4Ydszqxgkwft'},
  {name:'Meggadev',emoji:'✡️',addr:'8VUwMyYHkNn5qeC3Z2JY5k4BjkWXxNHoqvwSeWCSQKFu'},
  {name:'letteerbomb2',emoji:'💌',addr:'5GpPXNXFgVJ9vnhvccCJ2n1GtRQQrReF4agKSN5pZGCf'},
  {name:'Userz',emoji:'🌒',addr:'4ceopHPgw9wATNvAMnDdekQoLtRxs4ELvq4FAdMA8UQq'},
  {name:'tekquant',emoji:'🦄',addr:'FRa5xvWrvgYBHEukozdhJPCJRuJZcTn2WKj2u6L75Rmj'},
  ...
  {name:'China Wallet',emoji:'⏰',addr:'2sREjHDebSmqK9XPVM5nHR91ssr82j3a6ZGbcfgr9J7R'},
  {name:'Userz',emoji:'🌒',addr:'5fwibAmiWd9zVv9bNfp3wNbtqTv5nd6FAe1yNJqzhzwB'},
  {name:'Cotal',emoji:'🧀',addr:'6XJb1yPuBuBbjh45xrMDS4GyqtztvBHBDodWVqyqizHh'},
  ...
  {name:'zZZz',emoji:'💤',addr:'ZzZZzPoJxWKern9EMk88aik3P8KwKgptANPdrhERrwr'},
  {name:'Entropy',emoji:'💙',addr:'eAHPdAwmigwmMHXsLX4ibDh2ekQHCPdPxbffwdUUhj1'},
  {name:'samsrep',emoji:'🫑',addr:'CUHBzSPSaNS3tArEtM3maSV6pNdJhHJFYZpurPPK9P7H'},
  {name:'wagmi',emoji:'🤣',addr:'wgmioP6yGHB9WRtojJv2qpzj3v7zMUaYA9zWFGgrrbP'},
  {name:'zZZz',emoji:'💤',addr:'7DAWY3guSgAaa2d7y49JCGJxgTnGKBh7XaCmm1v2LkkC'},
  {name:'zZZz',emoji:'💤',addr:'Gvunzc6VsZXwmWD3QMR3zV1Lnd8ptobA3nMXjybTwX9q'},
  {name:'crypto villain',emoji:'💯',addr:'2XGR543rcHGqpxK6gtR5vxAyR7E8jAGiEbrtGyRa2NuC'},
  {name:'lunar',emoji:'☀️',addr:'BprdjjAzFLoS2gVJqUVR1pdJpwCacNK4kctLTiMmcdSh'},
  {name:'lunar',emoji:'☀️',addr:'2Xjizmu5FwVX36JyVGcWMDaNoQN1VWU25tz1TFk24nd7'},
  {name:'theoalt',emoji:'🏳️‍🌈',addr:'7Nt5HFpWzDfcvQLRmdRPkvDdq68n821wP1AGaWyqiAL6'},
  {name:'theoalt',emoji:'🏳️‍🌈',addr:'4Tf8hNjzyDQpbQ2CrJHqL9kC6HnDaN9pg4nEzdgHxVaG'},
  {name:'aismart',emoji:'🦓',addr:'9yYoY1t2752eh5T3W6Ckk6uFGp3e9R6J24NqqntTWDyU'},
  {name:'west',emoji:'⛑️',addr:'sYNUn7PJGiSVEXogedJuiXu2wzgsmvdRTesnr7MEezw'},
  {name:'blaster',emoji:'🧸',addr:'AVoW8jBv34tjAu5r8QcHXKzptMAFBmEEczEmMKZSNqq4'},
  {name:'decu',emoji:'🪝',addr:'4vw54BmAogeRV3vPKWyFet5yf8DTLcREzdSzx4rw9Ud9'},
  {name:'criminal',emoji:'🎭',addr:'HjNNPVtZUPqiRo2WWaJWHWncTpvdnnUqaWarYnrfDJgN'},
  {name:'mph',emoji:'🦋',addr:'5t1qjfihWT2JgWY2FiYikX1mdZaPcHYndv7qR6d12YEu'},
  {name:'samsrep2',emoji:'🫑',addr:'4xgnMkCPZN3AzZ3CnSVoQFiZmH31nseWiM4wvq8exERD'},
  {name:'chair fake ansem',emoji:'🙊',addr:'HXQxdXSQ812WPkkAAtqxb6pfXGMQE7Qi4SRpypB9LvK9'},
  {name:'Infinite',emoji:'⚡',addr:'DJEw8vxrVEtqXHkSiG3HARUEcx42v8aAUL8m4vWVhUL3'},
  {name:'Megga',emoji:'✡️',addr:'6QRdkwTSk9Kop6VdqSkSPah7a3HfqKHU5DD4BqMFCUQP'},
  {name:'ily',emoji:'💖',addr:'DXU65912VjiPUhKR37TLiHCrbp4uNHVNNZiBdLv1uAx1'},
  {name:'marcell',emoji:'🍈',addr:'FixmSpsBa7ew26gWdiqpoMAgKRFgbSXFbGAgfMZw67X'},
  ...
  {name:'Tim',emoji:'🐶',addr:'AfxdnsdzUGnXmFWaEXq6Hr9hninsWVpB5biJGN67PVpj'},
  {name:'Euris',emoji:'🔪',addr:'pEm51mXQqRTDYNnp9EfNPg5mL1rJaJfXKNXkbK56kYC'},
  {name:'dash',emoji:'💨',addr:'4ESzFZUWUdr2GsgHBVeQKuzAmBWS5sRSaXw6PZH2EAau'},
  {name:'pullupso',emoji:'🐻',addr:'65paNEG8m7mCVoASVF2KbRdU21aKXdASSB9G3NjCSQuE'},
  {name:'quantwallet',emoji:'🐴',addr:'12XmuPzMJjt1EzK39SYH8svHVDrMmoHZdP4ynKGH5QY4'},
  {name:'quantwalletmulti',emoji:'🐴',addr:'HjrHWsgwDQiceD3Rd24FhffKWvczEAHvLTYwbSm3xVNd'},
  {name:'tetsuoPID',emoji:'😀',addr:'5j9ZbT3mnPX5QjWVMrDaWFuaGf8ddji6LW1HVJw6kUE7'},
  {name:'testuo?',emoji:'⚠️',addr:'GF6vq2zivjAqThz5ZFQ2DqdqgrNF5FRS3bDUCktcNyzk'},
  ...
  {name:'log',emoji:'🪵',addr:'NiggaCd1i2bCVHQgPTjuPDazJVufuh19iRadTVthDye'},
  {name:'revrevrev',emoji:'⚙️',addr:'BoYDZhdrRmhWwqork2j7fx74CHSQJnFaNSXAXsDbVNSy'},
  {name:'west',emoji:'⛑️',addr:'28KxuZW9zo7j7c6oBHQkZsTY5vaNZExm9cCewogAaJou'},
  ...
  {name:'Zanjay',emoji:'🌴',addr:'3MQhDy175W6TT4sXsDHLq8tc7EqpphjYrSXFQKdMKNr3'},
  {name:'centeddev',emoji:'🔥',addr:'8YcbyX92UHTU23HZv3ccP9o13qibErQkKaUjoxqxd7SJ'},
  {name:'jerome',emoji:'🍍',addr:'4bLUksHbExppTW6ChEZintHMmurt4JXRx7RZrEBXpQq3'},
  {name:'jerome',emoji:'🍍',addr:'CDg3bPoM21fSXEzrXWHWyJR33JHX6xaYboq5p7s4uo48'},
  {name:'jidn2',emoji:'🕵️',addr:'84m6fNN3DtGAR1b6BUrvXRA54jN55n8KxUGnMU5LALWR'},
  {name:'jidn2',emoji:'🕵️',addr:'8PgvaArcAVh16hQvcBt4iWFaHxEqhMR8zSoc3sbt1wwV'},
  {name:'solcrow-fomo',emoji:'🦇',addr:'Bf4zji6S979QySiGNjPJ2VMZ5i2SRVtAzfx8QUBScJm6'},
  {name:'fizzwick',emoji:'🐀',addr:'3pcmVZ1DwKbqnjbGbeg3FycThT1AkTpGQYB96jGU6oS1'},
  {name:'agent',emoji:'💥',addr:'GmFrDZT2cdrqykgTikVdXbe8EtCgzUDM9VsDhQnwsUsG'},
  {name:'jerome',emoji:'🍍',addr:'GYaqGbgSd5iTiWUtfXMG57AfNdZwcd98y7eEfVhjQnVR'},
  {name:'bandit',emoji:'🥷',addr:'8GrjsuPip1xVDMjyVcVrG1wnM9Rutv7fdoxqtRBaymHc'}
];
...
// ─── main ──────────────────────────────────────────────────────────────────
async function main(){
  const LOOP_MS=4.5*60*1000;
  const WALLET_INTERVAL=30*1000;
  ...
  while(Date.now()-loopStart<LOOP_MS){
    ...
    // ── wallet buy checks (every iteration = every ~30s)
    await checkWalletBuys(state);

    // ── full token scan (every ~90s)
    if(Date.now()-lastScan>=SCAN_INTERVAL){
      ...
      if(pairs.length){
        ...
        let sent=0,alreadySeen=0,belowThr=0,crashFilter=0,holderFiltered=0;
        for(const t of tokens){
          ...
          if(!holderOk){
            ...
            holderFiltered++;
            seenSet.add(k);state.seenKeys.push(k);
            continue;
          }
          ...
          if(ok){
            ...
            console.error('[MAIN] send failed for',t.sym,'— will retry next scan');
          }
        }
    ...
    // sleep remainder of 30s window
    const elapsed=Date.now()-iterStart;
    const sleep=Math.max(0,WALLET_INTERVAL-elapsed);
